...
#LIBIEEE1284_CONFFILES=$(OPTWARE_PREFIX)etc/libieee1284.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibieee1284
...
#
# Binaries should be installed into $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/libieee1284/...
# Documentation files should be installed in $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)doc/libieee1284/...
# Daemon startup scripts should be installed in $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libieee1284
#
...
#	install -d $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBIEEE1284_SOURCE_DIR)/libieee1284.conf $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/libieee1284.conf
#	install -d $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBIEEE1284_SOURCE_DIR)/rc.libieee1284 $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibieee1284
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBIEEE1284_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibieee1284
