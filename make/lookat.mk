...
LOOKAT_CONFFILES=$(OPTWARE_PREFIX)etc/lookat.conf
...
#
# Binaries should be installed into $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/lookat/...
# Documentation files should be installed in $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)doc/lookat/...
# Daemon startup scripts should be installed in $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??lookat
#
...
#	install -d $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LOOKAT_SOURCE_DIR)/lookat.conf $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/lookat.conf
#	install -d $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LOOKAT_SOURCE_DIR)/rc.lookat $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlookat
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LOOKAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlookat
