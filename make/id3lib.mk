...
#ID3LIB_CONFFILES=$(OPTWARE_PREFIX)etc/id3lib.conf $(OPTWARE_PREFIX)etc/init.d/SXXid3lib
...
#
# Binaries should be installed into $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/id3lib/...
# Documentation files should be installed in $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)doc/id3lib/...
# Daemon startup scripts should be installed in $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??id3lib
#
...
#	install -d $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(ID3LIB_SOURCE_DIR)/id3lib.conf $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/id3lib.conf
#	install -d $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(ID3LIB_SOURCE_DIR)/rc.id3lib $(ID3LIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXid3lib
