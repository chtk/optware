...
PPOWER_CONFFILES=$(OPTWARE_PREFIX)etc/ppower.conf
#/etc/ppower.init
# $(OPTWARE_PREFIX)etc/init.d/SXXppower
...
#
# Binaries should be installed into $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/ppower/...
# Documentation files should be installed in $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)doc/ppower/...
# Daemon startup scripts should be installed in $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ppower
#
...
$(PPOWER_IPK): $(PPOWER_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)*bin/*
	install -d $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(PPOWER_BUILD_DIR)/etc/ppower.conf $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/ppower.conf
#	install -d $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(PPOWER_SOURCE_DIR)/rc.ppower $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXppower
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(PPOWER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXppower
