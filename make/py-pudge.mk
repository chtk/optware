...
#PY-PUDGE_CONFFILES=$(OPTWARE_PREFIX)etc/py-pudge.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-pudge
...
#
# Binaries should be installed into $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)etc/py-pudge/...
# Documentation files should be installed in $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)doc/py-pudge/...
# Daemon startup scripts should be installed in $(PY-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-pudge
#
...
$(PY25-PUDGE_IPK): $(PY-PUDGE_BUILD_DIR)/.built
	...
	for f in $(PY25-PUDGE_IPK_DIR)$(OPTWARE_PREFIX)bin/*; \
