...
PY26-SIMPLEJSON_DEPENDS=python26
...
#PY-SIMPLEJSON_CONFFILES=$(OPTWARE_PREFIX)etc/py-simplejson.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-simplejson
...
PY26-SIMPLEJSON_IPK_DIR=$(BUILD_DIR)/py26-simplejson-$(PY-SIMPLEJSON_VERSION)-ipk
PY26-SIMPLEJSON_IPK=$(BUILD_DIR)/py26-simplejson_$(PY-SIMPLEJSON_VERSION)-$(PY-SIMPLEJSON_IPK_VERSION)_$(TARGET_ARCH).ipk
...
#
$(PY-SIMPLEJSON_BUILD_DIR)/.configured: $(DL_DIR)/$(PY-SIMPLEJSON_SOURCE) $(PY-SIMPLEJSON_PATCHES) make/py-simplejson.mk
...
$(PY26-SIMPLEJSON_IPK_DIR)/CONTROL/control:
	...
	@echo "Source: $(PY-SIMPLEJSON_SITE)/$(PY-SIMPLEJSON_SOURCE)" >>$@
	@echo "Description: $(PY-SIMPLEJSON_DESCRIPTION)" >>$@
	@echo "Depends: $(PY26-SIMPLEJSON_DEPENDS)" >>$@
	@echo "Conflicts: $(PY-SIMPLEJSON_CONFLICTS)" >>$@

#
# This builds the IPK file.
#
# Binaries should be installed into $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/py-simplejson/...
# Documentation files should be installed in $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)doc/py-simplejson/...
# Daemon startup scripts should be installed in $(PY-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-simplejson
#
...
$(PY25-SIMPLEJSON_IPK): $(PY-SIMPLEJSON_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/simplejson/*.so
...
$(PY26-SIMPLEJSON_IPK): $(PY-SIMPLEJSON_BUILD_DIR)/.built
	rm -rf $(PY26-SIMPLEJSON_IPK_DIR) $(BUILD_DIR)/py26-simplejson_*_$(TARGET_ARCH).ipk
	cd $(PY-SIMPLEJSON_BUILD_DIR)/2.6; \
	    PYTHONPATH=$(STAGING_LIB_DIR)/python2.6/site-packages \
	    $(HOST_STAGING_PREFIX)/bin/python2.6 setup.py install \
	    --root=$(PY26-SIMPLEJSON_IPK_DIR) --prefix=/opt
	$(STRIP_COMMAND) $(PY26-SIMPLEJSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/simplejson/*.so
...
#
py-simplejson-ipk: $(PY25-SIMPLEJSON_IPK) $(PY26-SIMPLEJSON_IPK)
...
py-simplejson-dirclean:
	...
	rm -rf $(PY26-SIMPLEJSON_IPK_DIR) $(PY26-SIMPLEJSON_IPK)

#
# Some sanity check for the package.
#
py-simplejson-check: $(PY25-SIMPLEJSON_IPK) $(PY26-SIMPLEJSON_IPK)
