...
#FBCAT_CONFFILES=$(OPTWARE_PREFIX)etc/fbcat.conf $(OPTWARE_PREFIX)etc/init.d/SXXfbcat
...
#
# Binaries should be installed into $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX)etc/fbcat/...
# Documentation files should be installed in $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX)doc/fbcat/...
# Daemon startup scripts should be installed in $(FBCAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fbcat
#
