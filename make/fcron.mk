...
#
# Binaries should be installed into $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FCRON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)etc/fcron/...
# Documentation files should be installed in $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)doc/fcron/...
# Daemon startup scripts should be installed in $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fcron
#
...
#	install -m 755 $(FCRON_SOURCE_DIR)/rc.fcron $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXfcron
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(FCRON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXfcron
