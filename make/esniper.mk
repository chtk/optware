...
ESNIPER_VERSION+=2.27.0+$(ESNIPER_CVS_DATE)
ESNIPER_UPSTREAM_VERSION=$(ESNIPER_VERSION)
ESNIPER_DIR=esniper
else
ESNIPER_UPSTREAM_VERSION=2-27-0
ESNIPER_VERSION=2.27.0
...
#ESNIPER_CONFFILES=$(OPTWARE_PREFIX)etc/esniper.conf $(OPTWARE_PREFIX)etc/init.d/SXXesniper
...
#
# Binaries should be installed into $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX)etc/esniper/...
# Documentation files should be installed in $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX)doc/esniper/...
# Daemon startup scripts should be installed in $(ESNIPER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??esniper
#
