...
#
# Binaries should be installed into $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX)etc/alsa-oss/...
# Documentation files should be installed in $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX)doc/alsa-oss/...
# Daemon startup scripts should be installed in $(ALSA-OSS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??alsa-oss
#
