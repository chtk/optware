...
#PY-RDIFF-BACKUP_CONFFILES=$(OPTWARE_PREFIX)etc/py-rdiff-backup.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-rdiff-backup
...
#
$(PY-RDIFF-BACKUP_BUILD_DIR)/.configured: $(DL_DIR)/$(PY-RDIFF-BACKUP_SOURCE) $(PY-RDIFF-BACKUP_PATCHES) make/py-rdiff-backup.mk
...
#
# Binaries should be installed into $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)etc/py-rdiff-backup/...
# Documentation files should be installed in $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)doc/py-rdiff-backup/...
# Daemon startup scripts should be installed in $(PY-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-rdiff-backup
#
...
$(PY25-RDIFF-BACKUP_IPK): $(PY-RDIFF-BACKUP_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/*/*.so
...
$(PY26-RDIFF-BACKUP_IPK): $(PY-RDIFF-BACKUP_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY26-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/*/*.so
	rm -rf $(PY26-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)share
	for f in $(PY26-RDIFF-BACKUP_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
...
#
py-rdiff-backup-ipk: $(PY25-RDIFF-BACKUP_IPK) $(PY26-RDIFF-BACKUP_IPK)
...
#
py-rdiff-backup-check: $(PY25-RDIFF-BACKUP_IPK) $(PY26-RDIFF-BACKUP_IPK)
