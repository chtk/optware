...
#BRIDGE-UTILS_CONFFILES=$(OPTWARE_PREFIX)etc/bridge-utils.conf $(OPTWARE_PREFIX)etc/init.d/SXXbridge-utils
...
#
# Binaries should be installed into $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/bridge-utils/...
# Documentation files should be installed in $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/bridge-utils/...
# Daemon startup scripts should be installed in $(BRIDGE-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bridge-utils
#
