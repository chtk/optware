...
# NAGIOS_PLUGINS_CONFFILES=$(OPTWARE_PREFIX)etc/nagios-plugins.conf $(OPTWARE_PREFIX)etc/init.d/SXXnagios-plugins
...
#
# Binaries should be installed into $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/nagios-plugins/...
# Documentation files should be installed in $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)doc/nagios-plugins/...
# Daemon startup scripts should be installed in $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??nagios-plugins
#
...
$(NAGIOS_PLUGINS_IPK): $(NAGIOS_PLUGINS_BUILD_DIR)/.built
	...
	(cd $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)libexec; rm -f $(PLUGINS_REMOVE)) 
#	install -d $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(NAGIOS_PLUGINS_SOURCE_DIR)/nagios-plugins.conf $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/nagios-plugins.conf
#	install -d $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(NAGIOS_PLUGINS_SOURCE_DIR)/rc.nagios-plugins $(NAGIOS_PLUGINS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXnagios-plugins
