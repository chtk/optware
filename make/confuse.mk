...
#CONFUSE_CONFFILES=$(OPTWARE_PREFIX)etc/confuse.conf $(OPTWARE_PREFIX)etc/init.d/SXXconfuse
...
#
# Binaries should be installed into $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/confuse/...
# Documentation files should be installed in $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)doc/confuse/...
# Daemon startup scripts should be installed in $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??confuse
#
...
#	install -d $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(CONFUSE_SOURCE_DIR)/confuse.conf $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/confuse.conf
#	install -d $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(CONFUSE_SOURCE_DIR)/rc.confuse $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXconfuse
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(CONFUSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXconfuse
