...
#ASTERISK14_MOH_OPSOUND_ULAW_CONFFILES=$(OPTWARE_PREFIX)etc/asterisk14-moh-opsound-ulaw.conf $(OPTWARE_PREFIX)etc/init.d/SXXasterisk14-moh-opsound-ulaw
...
#
# Binaries should be installed into $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-moh-opsound-ulaw/...
# Documentation files should be installed in $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-moh-opsound-ulaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-moh-opsound-ulaw
#
...
$(ASTERISK14_MOH_OPSOUND_ULAW_IPK): $(ASTERISK14_MOH_OPSOUND_ULAW_BUILD_DIR)/.built
	...
	install -d $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/moh
	install -m 644 $(ASTERISK14_MOH_OPSOUND_ULAW_BUILD_DIR)/*ulaw $(ASTERISK14_MOH_OPSOUND_ULAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/moh
