...
#LIBNET10_CONFFILES=$(OPTWARE_PREFIX)etc/libnet10.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibnet10
...
#
# Binaries should be installed into $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/libnet10/...
# Documentation files should be installed in $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)doc/libnet10/...
# Daemon startup scripts should be installed in $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libnet10
#
...
#	install -d $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBNET10_SOURCE_DIR)/libnet10.conf $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/libnet10.conf
#	install -d $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBNET10_SOURCE_DIR)/rc.libnet10 $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibnet10
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBNET10_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibnet10
