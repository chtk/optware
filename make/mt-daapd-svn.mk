...
$(OPTWARE_PREFIX)etc/mt-daapd/mt-daapd.conf \
$(OPTWARE_PREFIX)etc/init.d/S60mt-daapd \
...
$(MT-DAAPD-SVN_IPK): $(MT-DAAPD-SVN_BUILD_DIR)/.built
	...
	install -d $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)var/log
	install -d $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -d $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/mt-daapd
	install -m 644 $(MT-DAAPD-SVN_BUILD_DIR)/contrib/mt-daapd.conf $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/mt-daapd/mt-daapd.conf
	sed -i -e '/^db_type/s/=.*/= sqlite3/' $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/mt-daapd/mt-daapd.conf
	install -d $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -m 755 $(MT-DAAPD-SVN_SOURCE_DIR)/rc.mt-daapd $(MT-DAAPD-SVN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S60mt-daapd
