...
#LIBTHEORA_CONFFILES=$(OPTWARE_PREFIX)etc/libtheora.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibtheora
...
#
# Binaries should be installed into $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/libtheora/...
# Documentation files should be installed in $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)doc/libtheora/...
# Daemon startup scripts should be installed in $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libtheora
#
...
#	install -d $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBTHEORA_SOURCE_DIR)/libtheora.conf $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/libtheora.conf
#	install -d $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBTHEORA_SOURCE_DIR)/rc.libtheora $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibtheora
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBTHEORA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibtheora
