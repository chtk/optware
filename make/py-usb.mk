...
#PY-USB_CONFFILES=$(OPTWARE_PREFIX)etc/py-usb.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-usb
...
#
# Binaries should be installed into $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX)etc/py-usb/...
# Documentation files should be installed in $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX)doc/py-usb/...
# Daemon startup scripts should be installed in $(PY-USB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-usb
#
...
$(PY24-USB_IPK): $(PY-USB_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-USB_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/usb.so
...
$(PY25-USB_IPK): $(PY-USB_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-USB_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/usb.so
