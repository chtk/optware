...
#
# Binaries should be installed into $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)etc/dspam/...
# Documentation files should be installed in $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)doc/dspam/...
# Daemon startup scripts should be installed in $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dspam
#
...
#	install -d $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(DSPAM_SOURCE_DIR)/dspam.conf $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)etc/dspam.conf
#	install -d $(DSPAM_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
