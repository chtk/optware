...
#KAFFE_CONFFILES=$(OPTWARE_PREFIX)etc/kaffe.conf $(OPTWARE_PREFIX)etc/init.d/SXXkaffe
...
#
KAFFE_CPPFLAGS=
KAFFE_LDFLAGS="-Wl,-rpath,$(OPTWARE_PREFIX)jre/lib/$(TARGET_ARCH)"
...
#
# Binaries should be installed into $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/kaffe/...
# Documentation files should be installed in $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)doc/kaffe/...
# Daemon startup scripts should be installed in $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??kaffe
#
...
#	install -d $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(KAFFE_SOURCE_DIR)/kaffe.conf $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/kaffe.conf
#	install -d $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(KAFFE_SOURCE_DIR)/rc.kaffe $(KAFFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXkaffe
