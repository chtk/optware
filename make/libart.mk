...
#LIBART_CONFFILES=$(OPTWARE_PREFIX)etc/libart.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibart
...
#
# Binaries should be installed into $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBART_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/libart/...
# Documentation files should be installed in $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)doc/libart/...
# Daemon startup scripts should be installed in $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libart
#
...
$(LIBART_IPK): $(LIBART_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)lib/*.so
#	install -d $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBART_SOURCE_DIR)/libart.conf $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/libart.conf
#	install -d $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBART_SOURCE_DIR)/rc.libart $(LIBART_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibart
