...
POPTOP_CONFFILES=$(OPTWARE_PREFIX)etc/init.d/S20poptop $(OPTWARE_PREFIX)etc/pptpd.conf $(OPTWARE_PREFIX)etc/ppp/options.pptpd
...
#
# Binaries should be installed into $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/poptop/...
# Documentation files should be installed in $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)doc/poptop/...
# Daemon startup scripts should be installed in $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??poptop
#
...
$(POPTOP_IPK): $(POPTOP_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)sbin/bcrelay
	$(STRIP_COMMAND) $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)sbin/pptpd
	$(STRIP_COMMAND) $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)sbin/pptpctrl
	$(STRIP_COMMAND) $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)lib/pptpd/*.so
	install -d $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(POPTOP_SOURCE_DIR)/pptpd.conf $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/pptpd.conf
	install -d $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/ppp
	install -m 644 $(POPTOP_SOURCE_DIR)/options.pptpd $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/ppp/options.pptpd
	install -d $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -m 755 $(POPTOP_SOURCE_DIR)/rc.poptop $(POPTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S20poptop
