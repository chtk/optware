...
#FSG3-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/fsg3-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXfsg3-kernel-modules
...
#
# Binaries should be installed into $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/fsg3-kernel-modules/...
# Documentation files should be installed in $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/fsg3-kernel-modules/...
# Daemon startup scripts should be installed in $(FSG3-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fsg3-kernel-modules
#
...
$(FSG3-KERNEL-MODULES_BUILD_DIR)/.ipkdone: $(FSG3-KERNEL-MODULES_BUILD_DIR)/.built
	...
	for m in $(FSG3-KERNEL-MODULES); do \
	  install -d $(FSG3-KERNEL-MODULES_IPK_DIR)-$$m$(OPTWARE_PREFIX)lib/modules; \
	  install -m 644 `find $(FSG3-KERNEL-MODULES_IPK_DIR) -name $$m.o` $(FSG3-KERNEL-MODULES_IPK_DIR)-$$m$(OPTWARE_PREFIX)lib/modules; \
	done
