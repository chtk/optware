...
PERL-EMAIL-SEND_DEPENDS=perl-email-address, perl-email-simple, perl-module-pluggable, perl-return-value
PERL-EMAIL-SEND_SUGGESTS=
PERL-EMAIL-SEND_CONFLICTS=

PERL-EMAIL-SEND_IPK_VERSION=2
...
$(PERL-EMAIL-SEND_IPK): $(PERL-EMAIL-SEND_BUILD_DIR)/.built
	...
	find $(PERL-EMAIL-SEND_IPK_DIR)$(OPTWARE_PREFIX)-name 'perllocal.pod' -exec rm -f {} \;
