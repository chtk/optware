...
#READLINE_CONFFILES=$(OPTWARE_PREFIX)etc/readline.conf $(OPTWARE_PREFIX)etc/init.d/SXXreadline
...
#
# Binaries should be installed into $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(READLINE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)etc/readline/...
# Documentation files should be installed in $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)doc/readline/...
# Daemon startup scripts should be installed in $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??readline
#
...
$(READLINE_IPK): $(READLINE_BUILD_DIR)/.built
	...
	rm -f $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)share/info/dir*
	(cd $(READLINE_IPK_DIR)$(OPTWARE_PREFIX)lib/ ; \
