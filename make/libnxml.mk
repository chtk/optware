...
#LIBNXML_CONFFILES=$(OPTWARE_PREFIX)etc/libnxml.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibnxml
...
#
# Binaries should be installed into $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX)etc/libnxml/...
# Documentation files should be installed in $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX)doc/libnxml/...
# Daemon startup scripts should be installed in $(LIBNXML_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libnxml
#
