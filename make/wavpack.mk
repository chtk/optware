...
#WAVPACK_CONFFILES=$(OPTWARE_PREFIX)etc/wavpack.conf $(OPTWARE_PREFIX)etc/init.d/SXXwavpack
...
#
# Binaries should be installed into $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/wavpack/...
# Documentation files should be installed in $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)doc/wavpack/...
# Daemon startup scripts should be installed in $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??wavpack
#
...
#	install -d $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(WAVPACK_SOURCE_DIR)/wavpack.conf $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/wavpack.conf
#	install -d $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(WAVPACK_SOURCE_DIR)/rc.wavpack $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXwavpack
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(WAVPACK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXwavpack
