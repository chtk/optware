...
#
# Binaries should be installed into $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/uclibcnotimpl/...
# Documentation files should be installed in $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)doc/uclibcnotimpl/...
# Daemon startup scripts should be installed in $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??uclibcnotimpl
#
...
#	$(MAKE) -C $(UCLIBCNOTIMPL_BUILD_DIR) DESTDIR=$(UCLIBCNOTIMPL_IPK_DIR) install-strip
	install -d $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)lib
	install -m 644  $(UCLIBCNOTIMPL_BUILD_DIR)/libuclibcnotimpl.a \
		$(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)lib/
#	install -m 644 $(UCLIBCNOTIMPL_SOURCE_DIR)/uclibcnotimpl.conf $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/uclibcnotimpl.conf
#	install -d $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(UCLIBCNOTIMPL_SOURCE_DIR)/rc.uclibcnotimpl $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXuclibcnotimpl
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(UCLIBCNOTIMPL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXuclibcnotimpl
