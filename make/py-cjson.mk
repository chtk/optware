...
#PY-CJSON_CONFFILES=$(OPTWARE_PREFIX)etc/py-cjson.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-cjson
...
#
# Binaries should be installed into $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/py-cjson/...
# Documentation files should be installed in $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX)doc/py-cjson/...
# Daemon startup scripts should be installed in $(PY-CJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-cjson
#
...
$(PY24-CJSON_IPK) $(PY25-CJSON_IPK): $(PY-CJSON_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-CJSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/cjson*.so
	...
	$(STRIP_COMMAND) $(PY25-CJSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/cjson*.so
	...
	$(STRIP_COMMAND) $(PY26-CJSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/cjson*.so
