...
#PY-STATLIB_CONFFILES=$(OPTWARE_PREFIX)etc/py-statlib.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-statlib
...
#
# Binaries should be installed into $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/py-statlib/...
# Documentation files should be installed in $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)doc/py-statlib/...
# Daemon startup scripts should be installed in $(PY-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-statlib
#
...
#	$(STRIP_COMMAND) $(PY25-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/bzrlib/*.so
...
#	$(STRIP_COMMAND) $(PY26-STATLIB_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/bzrlib/*.so
