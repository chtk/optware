...
#GSNMP_CONFFILES=$(OPTWARE_PREFIX)etc/gsnmp.conf $(OPTWARE_PREFIX)etc/init.d/SXXgsnmp
...
#
# Binaries should be installed into $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)etc/gsnmp/...
# Documentation files should be installed in $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)doc/gsnmp/...
# Daemon startup scripts should be installed in $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gsnmp
#
...
#	install -m 755 $(GSNMP_SOURCE_DIR)/rc.gsnmp $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgsnmp
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(GSNMP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgsnmp
