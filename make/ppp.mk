...
PPP_CONFFILES=$(OPTWARE_PREFIX)etc/ppp/options
...
#
# Binaries should be installed into $(PPP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PPP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PPP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PPP_IPK_DIR)$(OPTWARE_PREFIX)etc/ppp/...
# Documentation files should be installed in $(PPP_IPK_DIR)$(OPTWARE_PREFIX)doc/ppp/...
# Daemon startup scripts should be installed in $(PPP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ppp
#
# You may need to patch your application to make it use these locations.
#
$(PPP_IPK): $(PPP_BUILD_DIR)/.built
	rm -rf $(PPP_IPK_DIR) $(BUILD_DIR)/ppp_*_$(TARGET_ARCH).ipk
	install -d $(PPP_IPK_DIR)$(OPTWARE_PREFIX)sbin/
	install -m 755 $(PPP_BUILD_DIR)/pppd/pppd $(PPP_IPK_DIR)$(OPTWARE_PREFIX)sbin/pppd
	$(STRIP_COMMAND) $(PPP_IPK_DIR)$(OPTWARE_PREFIX)sbin/pppd
	install -d $(PPP_IPK_DIR)$(OPTWARE_PREFIX)etc/ppp
	install -m 644 $(PPP_BUILD_DIR)/etc.ppp/options $(PPP_IPK_DIR)$(OPTWARE_PREFIX)etc/ppp/options
