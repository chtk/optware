...
#SNOWNEWS_CONFFILES=$(OPTWARE_PREFIX)etc/snownews.conf $(OPTWARE_PREFIX)etc/init.d/SXXsnownews
...
#
# Binaries should be installed into $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)etc/snownews/...
# Documentation files should be installed in $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)doc/snownews/...
# Daemon startup scripts should be installed in $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??snownews
#
...
$(SNOWNEWS_IPK): $(SNOWNEWS_BUILD_DIR)/.built
	...
	$(TARGET_STRIP) $(SNOWNEWS_IPK_DIR)$(OPTWARE_PREFIX)bin/snownews
