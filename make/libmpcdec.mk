...
#LIBMPCDEC_CONFFILES=$(OPTWARE_PREFIX)etc/libmpcdec.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibmpcdec
...
#
# Binaries should be installed into $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/libmpcdec/...
# Documentation files should be installed in $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)doc/libmpcdec/...
# Daemon startup scripts should be installed in $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libmpcdec
#
...
$(LIBMPCDEC_IPK): $(LIBMPCDEC_BUILD_DIR)/.built
	...
	rm -f $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)lib/libmpcdec.la
#	install -d $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBMPCDEC_SOURCE_DIR)/libmpcdec.conf $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/libmpcdec.conf
#	install -d $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBMPCDEC_SOURCE_DIR)/rc.libmpcdec $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibmpcdec
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBMPCDEC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibmpcdec
