...
#
# Binaries should be installed into $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX)etc/fetchmail/...
# Documentation files should be installed in $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX)doc/fetchmail/...
# Daemon startup scripts should be installed in $(FETCHMAIL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fetchmail
#
