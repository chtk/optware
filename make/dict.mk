...
#
# Binaries should be installed into $(DICT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DICT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DICT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DICT_IPK_DIR)$(OPTWARE_PREFIX)etc/dict/...
# Documentation files should be installed in $(DICT_IPK_DIR)$(OPTWARE_PREFIX)doc/dict/...
# Daemon startup scripts should be installed in $(DICT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dict
#
