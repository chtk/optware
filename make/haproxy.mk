...
#HAPROXY_CONFFILES=$(OPTWARE_PREFIX)etc/haproxy.conf $(OPTWARE_PREFIX)etc/init.d/SXXhaproxy
...
#
# Binaries should be installed into $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX)etc/haproxy/...
# Documentation files should be installed in $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX)doc/haproxy/...
# Daemon startup scripts should be installed in $(HAPROXY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??haproxy
#
