...
#SLRN_CONFFILES=$(OPTWARE_PREFIX)etc/slrn.conf $(OPTWARE_PREFIX)etc/init.d/SXXslrn
...
#
# Binaries should be installed into $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SLRN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)etc/slrn/...
# Documentation files should be installed in $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)doc/slrn/...
# Daemon startup scripts should be installed in $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??slrn
#
...
$(SLRN_IPK): $(SLRN_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SLRN_IPK_DIR)$(OPTWARE_PREFIX)bin/slrn
