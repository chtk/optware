...
CROSSTOOL-NATIVE_HOSTCC ?= gcc-$(GCC_HOST_PROGRAM_SUFFIX)
...
CROSSTOOL-NATIVE_PREFIX=$(OPTWARE_PREFIX)$(TARGET_ARCH)
...
#
$(CROSSTOOL-NATIVE_BUILD_DIR)/.configured: $(DL_DIR)/$(CROSSTOOL-NATIVE_SOURCE) \
$(CROSSTOOL-NATIVE_PATCHES) make/crosstool-native.mk
	...
	cp $(CROSSTOOL-NATIVE_SOURCE_DIR)/$(CROSSTOOL-NATIVE_SCRIPT) \
		$(CROSSTOOL-NATIVE_BUILD_DIR)/$(CROSSTOOL-NATIVE_SCRIPT)
	cp $(CROSSTOOL-NATIVE_SOURCE_DIR)/*.dat $(CROSSTOOL-NATIVE_BUILD_DIR)
	mkdir -p $(CROSSTOOL-NATIVE_BUILD_DIR)/patches/gcc-3.3.5
	cp $(CROSSTOOL-NATIVE_BUILD_DIR)/patches/gcc-3.3.4/gcc-3.3.4-arm-bigendian.patch \
		$(CROSSTOOL-NATIVE_BUILD_DIR)/patches/gcc-3.3.5
...
$(CROSSTOOL-NATIVE_BUILD_DIR)/.built: $(CROSSTOOL-NATIVE_BUILD_DIR)/.configured
	$(HOST_TOOL_GCC$(GCC_HOST_TOOL_SUFFIX))
	rm -f $@
	...
	( cd $(CROSSTOOL-NATIVE_BUILD_DIR) ; \
		export RESULT_TOP=$(OPTWARE_PREFIX); \
		export PREFIX=$(CROSSTOOL-NATIVE_PREFIX) ; \
		export PATH=$(TOOL_BUILD_DIR)/$(GNU_TARGET_NAME)/$(CROSS_CONFIGURATION)/bin:$(PATH):$(HOST_STAGING_PREFIX)/bin ; \
		export TARBALLS_DIR=$(DL_DIR) ; \
...
#
# Binaries should be installed into $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)etc/crosstool-native/...
# Documentation files should be installed in $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)doc/crosstool-native/...
# Daemon startup scripts should be installed in $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??crosstool-native
#
...
# Install symlinks for common toolchain programs
	install -d $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)bin
	for f in ar as c++ g++ gcc ld nm ranlib strip ; do \
	  ...
	  ln -s $(CROSSTOOL-NATIVE_PREFIX)/bin/$(GNU_TARGET_NAME)-$$f $(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)bin/$$f ; \
	done
	ln -s $(CROSSTOOL-NATIVE_PREFIX)/bin/$(GNU_TARGET_NAME)-cpp  \
		$(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)bin/cpp
	ln -s $(CROSSTOOL-NATIVE_PREFIX)/bin/$(GNU_TARGET_NAME)-size \
		$(CROSSTOOL-NATIVE_IPK_DIR)$(OPTWARE_PREFIX)bin/size
...
# Package into bite-sized chunks
	...
	-mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/libexec \
		$(CROSSTOOL-NATIVE_IPK_DIR)-lib$(CROSSTOOL-NATIVE_PREFIX)/libexec
	...
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/info \
		$(CROSSTOOL-NATIVE_IPK_DIR)-inc$(CROSSTOOL-NATIVE_PREFIX)/info
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/man \
		$(CROSSTOOL-NATIVE_IPK_DIR)-inc$(CROSSTOOL-NATIVE_PREFIX)/man
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/tmp \
		$(CROSSTOOL-NATIVE_IPK_DIR)-inc$(CROSSTOOL-NATIVE_PREFIX)/tmp
	...
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/sbin \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-bin$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/sbin
	...
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/libexec \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-lib$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/libexec
	...
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/sys-include \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-inc$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/sys-include
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/etc \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-inc$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/etc
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/info \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-inc$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/info
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/share \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-inc$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/share
	mv $(CROSSTOOL-NATIVE_IPK_DIR)$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/usr \
		$(CROSSTOOL-NATIVE_IPK_DIR)-arch-inc$(CROSSTOOL-NATIVE_PREFIX)/$(GNU_TARGET_NAME)/usr
