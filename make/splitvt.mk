...
#SPLITVT_CONFFILES=$(OPTWARE_PREFIX)etc/splitvt.conf $(OPTWARE_PREFIX)etc/init.d/SXXsplitvt
...
#
# Binaries should be installed into $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)etc/splitvt/...
# Documentation files should be installed in $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)doc/splitvt/...
# Daemon startup scripts should be installed in $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??splitvt
#
...
$(SPLITVT_IPK): $(SPLITVT_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SPLITVT_IPK_DIR)$(OPTWARE_PREFIX)bin/splitvt
