...
PY24-RULEDISPATCH_DEPENDS=python24, py24-protocols (>=1.0a0)
...
PY24-RULEDISPATCH_IPK_DIR=$(BUILD_DIR)/py24-ruledispatch-$(PY-RULEDISPATCH_VERSION)-ipk
PY24-RULEDISPATCH_IPK=$(BUILD_DIR)/py24-ruledispatch_$(PY-RULEDISPATCH_VERSION)-$(PY-RULEDISPATCH_IPK_VERSION)_$(TARGET_ARCH).ipk
...
$(PY24-RULEDISPATCH_IPK): $(PY-RULEDISPATCH_BUILD_DIR)/.built
	rm -rf $(BUILD_DIR)/py-ruledispatch_*_$(TARGET_ARCH).ipk
	rm -rf $(PY24-RULEDISPATCH_IPK_DIR) $(BUILD_DIR)/py24-ruledispatch_*_$(TARGET_ARCH).ipk
	(cd $(PY-RULEDISPATCH_BUILD_DIR)/2.4; \
	PYTHONPATH=$(STAGING_LIB_DIR)/python2.4/site-packages \
