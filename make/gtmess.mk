...
#GTMESS_CONFFILES=$(OPTWARE_PREFIX)etc/gtmess.conf $(OPTWARE_PREFIX)etc/init.d/SXXgtmess
...
#
# Binaries should be installed into $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/gtmess/...
# Documentation files should be installed in $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)doc/gtmess/...
# Daemon startup scripts should be installed in $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gtmess
#
...
#	install -d $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(GTMESS_SOURCE_DIR)/gtmess.conf $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/gtmess.conf
#	install -d $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(GTMESS_SOURCE_DIR)/rc.gtmess $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgtmess
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(GTMESS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgtmess
