...
#LIBNFNETLINK_CONFFILES=$(OPTWARE_PREFIX)etc/libnfnetlink.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibnfnetlink
...
#
# Binaries should be installed into $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/libnfnetlink/...
# Documentation files should be installed in $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)doc/libnfnetlink/...
# Daemon startup scripts should be installed in $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libnfnetlink
#
...
$(LIBNFNETLINK_IPK): $(LIBNFNETLINK_BUILD_DIR)/.built
	...
	rm -rf $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)include
#	install -d $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBNFNETLINK_SOURCE_DIR)/libnfnetlink.conf $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/libnfnetlink.conf
#	install -d $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBNFNETLINK_SOURCE_DIR)/rc.libnfnetlink $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibnfnetlink
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBNFNETLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibnfnetlink
