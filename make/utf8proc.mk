...
#UTF8PROC_CONFFILES=$(OPTWARE_PREFIX)etc/utf8proc.conf $(OPTWARE_PREFIX)etc/init.d/SXXutf8proc
...
#
# Binaries should be installed into $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)etc/utf8proc/...
# Documentation files should be installed in $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)doc/utf8proc/...
# Daemon startup scripts should be installed in $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??utf8proc
#
...
#	$(MAKE) -C $(UTF8PROC_BUILD_DIR) DESTDIR=$(UTF8PROC_IPK_DIR) install-strip
	install -d $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)include $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)lib
	install -m 644 $(UTF8PROC_BUILD_DIR)/utf8proc.h $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)include/
	install -m 755 $(UTF8PROC_BUILD_DIR)/libutf8proc.so $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)lib/
	$(STRIP_COMMAND) $(UTF8PROC_IPK_DIR)$(OPTWARE_PREFIX)lib/libutf8proc.so
