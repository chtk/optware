...
#PY-GDCHART2_CONFFILES=$(OPTWARE_PREFIX)etc/py-gdchart2.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-gdchart2
...
#
# Binaries should be installed into $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)etc/py-gdchart2/...
# Documentation files should be installed in $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)doc/py-gdchart2/...
# Daemon startup scripts should be installed in $(PY-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-gdchart2
#
...
$(PY24-GDCHART2_IPK): $(PY-GDCHART2_BUILD_DIR)/.built
	...
	for so in `find $(PY24-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages -name '*.so'`; \
...
$(PY25-GDCHART2_IPK): $(PY-GDCHART2_BUILD_DIR)/.built
	...
	for so in `find $(PY25-GDCHART2_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages -name '*.so'`; \
		do $(STRIP_COMMAND) $$so; done
