...
#FREECELL_CONFFILES=$(OPTWARE_PREFIX)etc/freecell.conf $(OPTWARE_PREFIX)etc/init.d/SXXfreecell
...
#
# Binaries should be installed into $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX)etc/freecell/...
# Documentation files should be installed in $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX)doc/freecell/...
# Daemon startup scripts should be installed in $(FREECELL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??freecell
#
