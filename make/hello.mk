...
# HELLO_CONFFILES=$(OPTWARE_PREFIX)etc/hello.conf $(OPTWARE_PREFIX)etc/init.d/SXXhello
...
#
# Binaries should be installed into $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HELLO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/hello/...
# Documentation files should be installed in $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)doc/hello/...
# Daemon startup scripts should be installed in $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??hello
#
...
#	install -d $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(HELLO_SOURCE_DIR)/hello.conf $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/hello.conf
#	install -d $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(HELLO_SOURCE_DIR)/rc.hello $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXhello
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(HELLO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXhello
