...
#CMDFTP_CONFFILES=$(OPTWARE_PREFIX)etc/cmdftp.conf $(OPTWARE_PREFIX)etc/init.d/SXXcmdftp
...
#
# Binaries should be installed into $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/cmdftp/...
# Documentation files should be installed in $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX)doc/cmdftp/...
# Daemon startup scripts should be installed in $(CMDFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cmdftp
#
