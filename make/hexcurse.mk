...
#HEXCURSE_CONFFILES=$(OPTWARE_PREFIX)etc/hexcurse.conf $(OPTWARE_PREFIX)etc/init.d/SXXhexcurse
...
#
# Binaries should be installed into $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX)etc/hexcurse/...
# Documentation files should be installed in $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX)doc/hexcurse/...
# Daemon startup scripts should be installed in $(HEXCURSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??hexcurse
#
