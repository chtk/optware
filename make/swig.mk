...
#SWIG_CONFFILES=$(OPTWARE_PREFIX)etc/swig.conf $(OPTWARE_PREFIX)etc/init.d/SXXswig
...
#
# Binaries should be installed into $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SWIG_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)etc/swig/...
# Documentation files should be installed in $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)doc/swig/...
# Daemon startup scripts should be installed in $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??swig
#
...
$(SWIG_IPK): $(SWIG_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SWIG_IPK_DIR)$(OPTWARE_PREFIX)bin/*swig
