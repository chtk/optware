...
#LIBXSLT_CONFFILES=$(OPTWARE_PREFIX)etc/libxslt.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibxslt
...
$(LIBXSLT_BUILD_DIR)/.staged: $(LIBXSLT_BUILD_DIR)/.built
	...
	cp $(STAGING_DIR)$(OPTWARE_PREFIX)bin/xslt-config $(STAGING_DIR)/bin
...
#
# Binaries should be installed into $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)etc/libxslt/...
# Documentation files should be installed in $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)doc/libxslt/...
# Daemon startup scripts should be installed in $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libxslt
#
...
$(LIBXSLT_IPK): $(LIBXSLT_BUILD_DIR)/.built
	...
	rm -f $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)lib/libxslt.la
	rm -f $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)lib/libexslt.la
	rm -rf $(LIBXSLT_IPK_DIR)$(OPTWARE_PREFIX)share/doc
