...
#DEVMEM2_CONFFILES=$(OPTWARE_PREFIX)etc/devmem2.conf $(OPTWARE_PREFIX)etc/init.d/SXXdevmem2
...
#
# Binaries should be installed into $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX)etc/devmem2/...
# Documentation files should be installed in $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX)doc/devmem2/...
# Daemon startup scripts should be installed in $(DEVMEM2_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??devmem2
#
