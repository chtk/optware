...
#
# Binaries should be installed into $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)etc/ggrab/...
# Documentation files should be installed in $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)doc/ggrab/...
# Daemon startup scripts should be installed in $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ggrab
#
...
#	install -m 755 $(GGRAB_SOURCE_DIR)/rc.ggrab $(GGRAB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXggrab
