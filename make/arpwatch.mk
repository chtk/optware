...
#ARPWATCH_CONFFILES=$(OPTWARE_PREFIX)etc/arpwatch.conf $(OPTWARE_PREFIX)etc/init.d/SXXarpwatch
...
#
# Binaries should be installed into $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)etc/arpwatch/...
# Documentation files should be installed in $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)doc/arpwatch/...
# Daemon startup scripts should be installed in $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??arpwatch
#
...
#	install -d $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(ARPWATCH_SOURCE_DIR)/rc.arpwatch $(ARPWATCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXarpwatch
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXarpwatch
