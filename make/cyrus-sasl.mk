...
#
# Binaries should be installed into $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX)etc/cyrus-sasl/...
# Documentation files should be installed in $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX)doc/cyrus-sasl/...
# Daemon startup scripts should be installed in $(CYRUS-SASL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cyrus-sasl
#
