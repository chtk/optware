...
#INDENT_CONFFILES=$(OPTWARE_PREFIX)etc/indent.conf $(OPTWARE_PREFIX)etc/init.d/SXXindent
...
#
# Binaries should be installed into $(INDENT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(INDENT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(INDENT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(INDENT_IPK_DIR)$(OPTWARE_PREFIX)etc/indent/...
# Documentation files should be installed in $(INDENT_IPK_DIR)$(OPTWARE_PREFIX)doc/indent/...
# Daemon startup scripts should be installed in $(INDENT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??indent
#
