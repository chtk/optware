...
#NCDU_CONFFILES=$(OPTWARE_PREFIX)etc/ncdu.conf $(OPTWARE_PREFIX)etc/init.d/SXXncdu
...
#
# Binaries should be installed into $(NCDU_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NCDU_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NCDU_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NCDU_IPK_DIR)$(OPTWARE_PREFIX)etc/ncdu/...
# Documentation files should be installed in $(NCDU_IPK_DIR)$(OPTWARE_PREFIX)doc/ncdu/...
# Daemon startup scripts should be installed in $(NCDU_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ncdu
#
