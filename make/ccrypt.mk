...
#CCRYPT_CONFFILES=$(OPTWARE_PREFIX)etc/ccrypt.conf $(OPTWARE_PREFIX)etc/init.d/SXXccrypt
...
#
# Binaries should be installed into $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX)etc/ccrypt/...
# Documentation files should be installed in $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX)doc/ccrypt/...
# Daemon startup scripts should be installed in $(CCRYPT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ccrypt
#
