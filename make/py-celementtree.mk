...
#PY-CELEMENTTREE_CONFFILES=$(OPTWARE_PREFIX)etc/py-celementtree.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-celementtree
...
#
# Binaries should be installed into $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)etc/py-celementtree/...
# Documentation files should be installed in $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)doc/py-celementtree/...
# Daemon startup scripts should be installed in $(PY-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-celementtree
#
...
$(PY24-CELEMENTTREE_IPK): $(PY-CELEMENTTREE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/*.so
...
$(PY25-CELEMENTTREE_IPK): $(PY-CELEMENTTREE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-CELEMENTTREE_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/*.so
