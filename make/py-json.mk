...
#PY-JSON_CONFFILES=$(OPTWARE_PREFIX)etc/py-json.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-json
...
PY-JSON_PYLIBDIR=$(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages
...
#
# Binaries should be installed into $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)etc/py-json/...
# Documentation files should be installed in $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)doc/py-json/...
# Daemon startup scripts should be installed in $(PY-JSON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-json
#
