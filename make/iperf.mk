...
#IPERF_CONFFILES=$(OPTWARE_PREFIX)etc/iperf.conf $(OPTWARE_PREFIX)etc/init.d/SXXiperf
...
#
# Binaries should be installed into $(IPERF_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IPERF_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IPERF_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IPERF_IPK_DIR)$(OPTWARE_PREFIX)etc/iperf/...
# Documentation files should be installed in $(IPERF_IPK_DIR)$(OPTWARE_PREFIX)doc/iperf/...
# Daemon startup scripts should be installed in $(IPERF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??iperf
#
