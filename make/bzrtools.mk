...
#BZRTOOLS_CONFFILES=$(OPTWARE_PREFIX)etc/bzrtools.conf $(OPTWARE_PREFIX)etc/init.d/SXXbzrtools
...
#
# Binaries should be installed into $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX)etc/bzrtools/...
# Documentation files should be installed in $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX)doc/bzrtools/...
# Daemon startup scripts should be installed in $(BZRTOOLS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bzrtools
#
