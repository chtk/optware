...
#ETTERCAP_CONFFILES=$(OPTWARE_PREFIX)etc/ettercap.conf $(OPTWARE_PREFIX)etc/init.d/SXXettercap
...
#
# Binaries should be installed into $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX)etc/ettercap/...
# Documentation files should be installed in $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX)doc/ettercap/...
# Daemon startup scripts should be installed in $(ETTERCAP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ettercap
#
