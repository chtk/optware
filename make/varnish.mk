...
#VARNISH_CONFFILES=$(OPTWARE_PREFIX)etc/varnish.conf $(OPTWARE_PREFIX)etc/init.d/SXXvarnish
...
#
# Binaries should be installed into $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/varnish/...
# Documentation files should be installed in $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)doc/varnish/...
# Daemon startup scripts should be installed in $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??varnish
#
...
#	install -d $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(VARNISH_SOURCE_DIR)/varnish.conf $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/varnish.conf
#	install -d $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(VARNISH_SOURCE_DIR)/rc.varnish $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXvarnish
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(VARNISH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXvarnish
