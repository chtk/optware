...
#ICES0_CONFFILES=$(OPTWARE_PREFIX)etc/ices.conf $(OPTWARE_PREFIX)etc/init.d/SXXices
...
#
# Binaries should be installed into $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ICES0_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/ices/...
# Documentation files should be installed in $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)doc/ices/...
# Daemon startup scripts should be installed in $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ices
#
...
#	install -d $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(ICES0_SOURCE_DIR)/ices.conf $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/ices.conf
#	install -d $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(ICES0_SOURCE_DIR)/rc.ices $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXices
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(ICES0_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXices
