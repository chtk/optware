...
#
PHP_CONFFILES=$(OPTWARE_PREFIX)etc/php.ini
...
#
# PHP_CONFFILES should be a list of user-editable files
#PHP_CONFFILES=$(OPTWARE_PREFIX)etc/php.conf $(OPTWARE_PREFIX)etc/init.d/SXXphp
...
PHP_LDFLAGS=-L$(STAGING_LIB_DIR)/mysql -Wl,-rpath=$(OPTWARE_PREFIX)lib/mysql -ldl -lpthread
...
#
# Binaries should be installed into $(PHP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PHP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PHP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PHP_IPK_DIR)$(OPTWARE_PREFIX)etc/php/...
# Documentation files should be installed in $(PHP_IPK_DIR)$(OPTWARE_PREFIX)doc/php/...
# Daemon startup scripts should be installed in $(PHP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??php
#
# You may need to patch your application to make it use these locations.
#
$(PHP_TARGET_IPKS): $(PHP_BUILD_DIR)/.built
	rm -rf $(PHP_IPK_DIR) $(BUILD_DIR)/php_*_$(TARGET_ARCH).ipk
	install -d $(PHP_IPK_DIR)$(OPTWARE_PREFIX)var/lib/php/session
	chmod a=rwx $(PHP_IPK_DIR)$(OPTWARE_PREFIX)var/lib/php/session
	$(MAKE) -C $(PHP_BUILD_DIR) INSTALL_ROOT=$(PHP_IPK_DIR) program_prefix="" install
	$(STRIP_COMMAND) $(PHP_IPK_DIR)$(OPTWARE_PREFIX)bin/php
	$(STRIP_COMMAND) $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/*.so
	$(STRIP_COMMAND) $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/*.so
	rm -f $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/*.a
	install -d $(PHP_IPK_DIR)$(OPTWARE_PREFIX)etc
	install -d $(PHP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	install -m 644 $(PHP_SOURCE_DIR)/php.ini $(PHP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.ini
	### now make php-dev
	rm -rf $(PHP_DEV_IPK_DIR) $(BUILD_DIR)/php-dev_*_$(TARGET_ARCH).ipk
	$(MAKE) $(PHP_DEV_IPK_DIR)/CONTROL/control
	install -d $(PHP_DEV_IPK_DIR)$(OPTWARE_PREFIX)lib/php
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/build $(PHP_DEV_IPK_DIR)$(OPTWARE_PREFIX)lib/php/
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)include $(PHP_DEV_IPK_DIR)$(OPTWARE_PREFIX)
	...
	install -d $(PHP_EMBED_IPK_DIR)$(OPTWARE_PREFIX)lib/
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/libphp5.so $(PHP_EMBED_IPK_DIR)$(OPTWARE_PREFIX)lib
	...
	install -d $(PHP_CURL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_CURL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/curl.so $(PHP_CURL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/curl.so
	echo extension=curl.so >$(PHP_CURL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/curl.ini
	...
	install -d $(PHP_GD_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_GD_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/gd.so $(PHP_GD_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/gd.so
	echo extension=gd.so >$(PHP_GD_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/gd.ini
...
ifeq (, $(filter --without-iconv, $(PHP_CONFIGURE_ARGS)))
	...
	install -d $(PHP_ICONV_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_ICONV_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/iconv.so $(PHP_ICONV_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/iconv.so
	echo extension=iconv.so >$(PHP_ICONV_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/iconv.ini
	...
	install -d $(PHP_IMAP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_IMAP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/imap.so $(PHP_IMAP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/imap.so
	echo extension=imap.so >$(PHP_IMAP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/imap.ini
...
ifeq (openldap, $(filter openldap, $(PACKAGES)))
	...
	install -d $(PHP_LDAP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_LDAP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/ldap.so $(PHP_LDAP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/ldap.so
	echo extension=ldap.so >$(PHP_LDAP_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/ldap.ini
	...
	install -d $(PHP_MBSTRING_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_MBSTRING_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/mbstring.so $(PHP_MBSTRING_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/mbstring.so
	echo extension=mbstring.so >$(PHP_MBSTRING_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/mbstring.ini
	...
	install -d $(PHP_MYSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_MYSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/*mysql*.so $(PHP_MYSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/
	echo extension=mysql.so >$(PHP_MYSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/mysql.ini
	echo extension=mysqli.so >>$(PHP_MYSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/mysql.ini
	...
	install -d $(PHP_PEAR_IPK_DIR)$(OPTWARE_PREFIX)etc
	install -m 644 $(PHP_SOURCE_DIR)/pear.conf $(PHP_PEAR_IPK_DIR)$(OPTWARE_PREFIX)etc/pear.conf.new
	install -d $(PHP_PEAR_IPK_DIR)$(OPTWARE_PREFIX)etc/pearkeys
	install -d $(PHP_PEAR_IPK_DIR)$(OPTWARE_PREFIX)tmp
	cp -a $(PHP_BUILD_DIR)/pear $(PHP_PEAR_IPK_DIR)$(OPTWARE_PREFIX)tmp
	...
	install -d $(PHP_PGSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_PGSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/*pgsql*.so $(PHP_PGSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/
	echo extension=pgsql.so >$(PHP_PGSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/pgsql.ini
	...
	install -d $(PHP_MSSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_MSSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/mssql.so $(PHP_MSSQL_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/
	echo extension=mssql.so >$(PHP_MSSQL_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/mssql.ini
	...
	install -d $(PHP_ODBC_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_ODBC_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/odbc.so $(PHP_ODBC_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/
	echo extension=odbc.so >$(PHP_ODBC_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/odbc.ini
	...
	install -d $(PHP_XMLRPC_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions
	install -d $(PHP_XMLRPC_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d
	mv $(PHP_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/xmlrpc.so $(PHP_XMLRPC_IPK_DIR)$(OPTWARE_PREFIX)lib/php/extensions/
	echo extension=xmlrpc.so >$(PHP_XMLRPC_IPK_DIR)$(OPTWARE_PREFIX)etc/php.d/xmlrpc.ini
