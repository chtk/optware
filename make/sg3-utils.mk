...
#SG3-UTILS_CONFFILES=$(OPTWARE_PREFIX)etc/sg3-utils.conf $(OPTWARE_PREFIX)etc/init.d/SXXsg3-utils
...
#
# Binaries should be installed into $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/sg3-utils/...
# Documentation files should be installed in $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/sg3-utils/...
# Daemon startup scripts should be installed in $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??sg3-utils
#
...
#	install -d $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(SG3-UTILS_SOURCE_DIR)/sg3-utils.conf $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/sg3-utils.conf
#	install -d $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(SG3-UTILS_SOURCE_DIR)/rc.sg3-utils $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXsg3-utils
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SG3-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXsg3-utils
