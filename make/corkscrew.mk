...
#CORKSCREW_CONFFILES=$(OPTWARE_PREFIX)etc/corkscrew.conf $(OPTWARE_PREFIX)etc/init.d/SXXcorkscrew
...
#
# Binaries should be installed into $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)etc/corkscrew/...
# Documentation files should be installed in $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)doc/corkscrew/...
# Daemon startup scripts should be installed in $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??corkscrew
#
...
$(CORKSCREW_IPK): $(CORKSCREW_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)/bin/corkscrew
	install -d $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)/share/doc/corkscrew
	install $(CORKSCREW_BUILD_DIR)/[ACINRT]* $(CORKSCREW_IPK_DIR)$(OPTWARE_PREFIX)/share/doc/corkscrew
