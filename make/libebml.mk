...
#LIBEBML_CONFFILES=$(OPTWARE_PREFIX)etc/libebml.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibebml
...
#
# Binaries should be installed into $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)etc/libebml/...
# Documentation files should be installed in $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)doc/libebml/...
# Daemon startup scripts should be installed in $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libebml
#
...
$(LIBEBML_IPK): $(LIBEBML_BUILD_DIR)/.built
	...
	$(MAKE) -C $(LIBEBML_BUILD_DIR)/make/linux install_sharedlib \
		...
		prefix=$(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)\
		;
	$(STRIP_COMMAND) $(LIBEBML_IPK_DIR)$(OPTWARE_PREFIX)lib/libebml.so.*
