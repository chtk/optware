...
#
# Binaries should be installed into $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TAGED_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)etc/taged/...
# Documentation files should be installed in $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)doc/taged/...
# Daemon startup scripts should be installed in $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??taged
#
...
$(TAGED_IPK): $(TAGED_BUILD_DIR)/.built
	...
	rm -rf $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)lib $(TAGED_IPK_DIR)$(OPTWARE_PREFIX)include
