...
# UNITS_CONFFILES=$(OPTWARE_PREFIX)etc/units.conf $(OPTWARE_PREFIX)etc/init.d/SXXunits
...
#
# Binaries should be installed into $(UNITS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UNITS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UNITS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UNITS_IPK_DIR)$(OPTWARE_PREFIX)etc/units/...
# Documentation files should be installed in $(UNITS_IPK_DIR)$(OPTWARE_PREFIX)doc/units/...
# Daemon startup scripts should be installed in $(UNITS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??units
#
