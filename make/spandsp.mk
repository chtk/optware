...
#SPANDSP_CONFFILES=$(OPTWARE_PREFIX)etc/spandsp.conf $(OPTWARE_PREFIX)etc/init.d/SXXspandsp
...
#
# Binaries should be installed into $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX)etc/spandsp/...
# Documentation files should be installed in $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX)doc/spandsp/...
# Daemon startup scripts should be installed in $(SPANDSP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??spandsp
#
