...
#FIS_CONFFILES=$(OPTWARE_PREFIX)etc/fis.conf $(OPTWARE_PREFIX)etc/init.d/SXXfis
...
#
# Binaries should be installed into $(FIS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FIS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FIS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FIS_IPK_DIR)$(OPTWARE_PREFIX)etc/fis/...
# Documentation files should be installed in $(FIS_IPK_DIR)$(OPTWARE_PREFIX)doc/fis/...
# Daemon startup scripts should be installed in $(FIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fis
#
