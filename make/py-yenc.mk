...
#PY-YENC_CONFFILES=$(OPTWARE_PREFIX)etc/py-yenc.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-yenc
...
#
# Binaries should be installed into $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX)etc/py-yenc/...
# Documentation files should be installed in $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX)doc/py-yenc/...
# Daemon startup scripts should be installed in $(PY-YENC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-yenc
#
...
$(PY24-YENC_IPK): $(PY-YENC_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-YENC_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/*.so
...
$(PY25-YENC_IPK): $(PY-YENC_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-YENC_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/*.so
