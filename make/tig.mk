...
#TIG_CONFFILES=$(OPTWARE_PREFIX)etc/tig.conf $(OPTWARE_PREFIX)etc/init.d/SXXtig
...
#
# Binaries should be installed into $(TIG_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TIG_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TIG_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TIG_IPK_DIR)$(OPTWARE_PREFIX)etc/tig/...
# Documentation files should be installed in $(TIG_IPK_DIR)$(OPTWARE_PREFIX)doc/tig/...
# Daemon startup scripts should be installed in $(TIG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??tig
#
