...
#PY-TRAC_CONFFILES=$(OPTWARE_PREFIX)etc/py-trac.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-trac
...
#
# Binaries should be installed into $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX)etc/py-trac/...
# Documentation files should be installed in $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX)doc/py-trac/...
# Daemon startup scripts should be installed in $(PY-TRAC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-trac
#
...
$(PY25-TRAC_IPK): $(PY-TRAC_BUILD_DIR)/.built
	...
	for f in $(PY25-TRAC_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
