...
#DT2-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/dt2-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXdt2-kernel-modules
...
#
# Binaries should be installed into $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/dt2-kernel-modules/...
# Documentation files should be installed in $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/dt2-kernel-modules/...
# Daemon startup scripts should be installed in $(DT2-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dt2-kernel-modules
#
