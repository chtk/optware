...
#LIBMRSS_CONFFILES=$(OPTWARE_PREFIX)etc/libmrss.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibmrss
...
#
# Binaries should be installed into $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX)etc/libmrss/...
# Documentation files should be installed in $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX)doc/libmrss/...
# Daemon startup scripts should be installed in $(LIBMRSS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libmrss
#
