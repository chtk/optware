...
#PY-YAML_CONFFILES=$(OPTWARE_PREFIX)etc/py-yaml.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-yaml
...
#
# Binaries should be installed into $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX)etc/py-yaml/...
# Documentation files should be installed in $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX)doc/py-yaml/...
# Daemon startup scripts should be installed in $(PY-YAML_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-yaml
#
