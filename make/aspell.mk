...
ASPELL_CONFFILES=$(OPTWARE_PREFIX)etc/aspell.conf
...
#
# Binaries should be installed into $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/aspell/...
# Documentation files should be installed in $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)doc/aspell/...
# Daemon startup scripts should be installed in $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??aspell
#
...
$(ASPELL_IPK): $(ASPELL_BUILD_DIR)/.built
	...
	install -d $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(ASPELL_SOURCE_DIR)/aspell.conf $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/aspell.conf
#	install -d $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(ASPELL_SOURCE_DIR)/rc.aspell $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXaspell
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(ASPELL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXaspell
