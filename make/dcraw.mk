...
#DCRAW_CONFFILES=$(OPTWARE_PREFIX)etc/dcraw.conf $(OPTWARE_PREFIX)etc/init.d/SXXdcraw
...
#
# Binaries should be installed into $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/dcraw/...
# Documentation files should be installed in $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)doc/dcraw/...
# Daemon startup scripts should be installed in $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dcraw
#
...
#	install -d $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(DCRAW_SOURCE_DIR)/rc.dcraw $(DCRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXdcraw
