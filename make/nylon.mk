...
NYLON_CONFFILES=$(OPTWARE_PREFIX)etc/nylon.conf
...
#
# Binaries should be installed into $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NYLON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc/nylon/...
# Documentation files should be installed in $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)doc/nylon/...
# Daemon startup scripts should be installed in $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??nylon
#
...
$(NYLON_IPK): $(NYLON_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)bin/nylon
	install -d $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)var/run
	install -d $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc
	install -m 644 $(NYLON_SOURCE_DIR)/nylon.conf $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc/nylon.conf
	install -d $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -m 755 $(NYLON_SOURCE_DIR)/rc.nylon $(NYLON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S10nylon
