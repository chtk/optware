...
#PY-BUILDUTILS_CONFFILES=$(OPTWARE_PREFIX)etc/py-buildutils.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-buildutils
...
#
# Binaries should be installed into $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/py-buildutils/...
# Documentation files should be installed in $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/py-buildutils/...
# Daemon startup scripts should be installed in $(PY-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-buildutils
#
...
$(PY25-BUILDUTILS_IPK): $(PY-BUILDUTILS_BUILD_DIR)/.built
	...
	for f in $(PY25-BUILDUTILS_IPK_DIR)$(OPTWARE_PREFIX)bin/*; \
