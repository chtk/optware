...
MINICOM_CONFFILES=$(OPTWARE_PREFIX)etc/minirc.dfl
...
#
# Binaries should be installed into $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)etc/minicom/...
# Documentation files should be installed in $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)doc/minicom/...
# Daemon startup scripts should be installed in $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??minicom
#
...
$(MINICOM_IPK): $(MINICOM_BUILD_DIR)/.built
	...
	$(TARGET_STRIP) $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)bin/ascii-xfr
	$(TARGET_STRIP) $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)bin/minicom
	$(TARGET_STRIP) $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)bin/runscript
	install -d $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 755 $(MINICOM_BUILD_DIR)/doc/minirc.dfl $(MINICOM_IPK_DIR)$(OPTWARE_PREFIX)etc/minirc.dfl
