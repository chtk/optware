...
#GLOOX_CONFFILES=$(OPTWARE_PREFIX)etc/gloox.conf $(OPTWARE_PREFIX)etc/init.d/SXXgloox
...
#
# Binaries should be installed into $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX)etc/gloox/...
# Documentation files should be installed in $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX)doc/gloox/...
# Daemon startup scripts should be installed in $(GLOOX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gloox
#
