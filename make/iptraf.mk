...
#IPTRAF_CONFFILES=$(OPTWARE_PREFIX)etc/iptraf.conf $(OPTWARE_PREFIX)etc/init.d/SXXiptraf
...
#
# Binaries should be installed into $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX)etc/iptraf/...
# Documentation files should be installed in $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX)doc/iptraf/...
# Daemon startup scripts should be installed in $(IPTRAF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??iptraf
#
