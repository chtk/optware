...
# PWGEN_CONFFILES=/etc/pwgend.conf $(OPTWARE_PREFIX)etc/init.d/S05pwgend
...
#
# Binaries should be installed into $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)bin
...
$(PWGEN_IPK): $(PWGEN_BUILD_DIR)/.built
	...
	install -d $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -m 755 $(PWGEN_BUILD_DIR)/pwgen $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)bin/*
	install -d $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)man/man1
	install -m 644 $(PWGEN_BUILD_DIR)/pwgen.1 $(PWGEN_IPK_DIR)$(OPTWARE_PREFIX)man/man1
