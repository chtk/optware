...
#
# Binaries should be installed into $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GROFF_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)etc/groff/...
# Documentation files should be installed in $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)doc/groff/...
# Daemon startup scripts should be installed in $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??groff
#
...
$(GROFF_IPK): $(GROFF_BUILD_DIR)/.built
	...
	install -d $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)
	install -d $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/info
	$(MAKE) -C $(GROFF_BUILD_DIR) DESTDIR=$(GROFF_IPK_DIR) install
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/addftinfo
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/eqn
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grn
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grodvi
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/groff
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grolbp
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grolj4
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grops
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/grotty
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/hpftodit
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/indxbib
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/lkbib
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/lookbib
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/pfbtops
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/pic
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/post-grohtml
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/pre-grohtml
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/refer
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/soelim
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/tbl
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/tfmtodit
	$(STRIP_COMMAND) $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/bin/troff
	rm -f $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/info/dir
	rm -f $(GROFF_IPK_DIR)$(OPTWARE_PREFIX)/info/dir.old
