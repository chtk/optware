...
#PY-TURBOJSON_CONFFILES=$(OPTWARE_PREFIX)etc/py-turbojson.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-turbojson
...
#
# Binaries should be installed into $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/py-turbojson/...
# Documentation files should be installed in $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX)doc/py-turbojson/...
# Daemon startup scripts should be installed in $(PY-TURBOJSON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-turbojson
#
