...
XPDF_CONFFILES=$(OPTWARE_PREFIX)etc/xpdfrc
...
#
# Binaries should be installed into $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XPDF_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/xpdf/...
# Documentation files should be installed in $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)doc/xpdf/...
# Daemon startup scripts should be installed in $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xpdf
#
...
$(XPDF_IPK): $(XPDF_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)bin/*
	#install -d $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/
	#install -m 644 $(XPDF_SOURCE_DIR)/xpdf.conf $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/xpdf.conf
	#install -d $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	#install -m 755 $(XPDF_SOURCE_DIR)/rc.xpdf $(XPDF_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXxpdf
