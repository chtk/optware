...
#SOX_CONFFILES=$(OPTWARE_PREFIX)etc/sox.conf $(OPTWARE_PREFIX)etc/init.d/SXXsox
...
#
# Binaries should be installed into $(SOX_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SOX_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SOX_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SOX_IPK_DIR)$(OPTWARE_PREFIX)etc/sox/...
# Documentation files should be installed in $(SOX_IPK_DIR)$(OPTWARE_PREFIX)doc/sox/...
# Daemon startup scripts should be installed in $(SOX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??sox
#
