...
#BSDGAMES_CONFFILES=$(OPTWARE_PREFIX)etc/bsdgames.conf $(OPTWARE_PREFIX)etc/init.d/SXXbsdgames
...
#
# Binaries should be installed into $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX)etc/bsdgames/...
# Documentation files should be installed in $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX)doc/bsdgames/...
# Daemon startup scripts should be installed in $(BSDGAMES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bsdgames
#
