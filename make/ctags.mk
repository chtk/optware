...
#CTAGS_CONFFILES=$(OPTWARE_PREFIX)etc/ctags.conf $(OPTWARE_PREFIX)etc/init.d/SXXctags
...
#
# Binaries should be installed into $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)etc/ctags/...
# Documentation files should be installed in $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)doc/ctags/...
# Daemon startup scripts should be installed in $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ctags
#
# You may need to patch your application to make it use these locations.
#
$(CTAGS_IPK): $(CTAGS_BUILD_DIR)/.built
	rm -rf $(CTAGS_IPK_DIR) $(BUILD_DIR)/ctags_*_$(TARGET_ARCH).ipk
	$(MAKE) -C $(CTAGS_BUILD_DIR) DESTDIR=$(CTAGS_IPK_DIR) prefix=$(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)install
	$(STRIP_COMMAND) $(CTAGS_IPK_DIR)$(OPTWARE_PREFIX)bin/ctags
