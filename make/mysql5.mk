...
MYSQL5_CONFFILES=$(OPTWARE_PREFIX)etc/my.cnf
...
#
MYSQL5_CPPFLAGS ?=
MYSQL5_LDFLAGS="-Wl,-rpath,$(OPTWARE_PREFIX)lib/mysql"
...
#
# Binaries should be installed into $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/mysql/...
# Documentation files should be installed in $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)doc/mysql/...
# Daemon startup scripts should be installed in $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mysql
#
...
$(MYSQL5_IPK): $(MYSQL5_BUILD_DIR)/.built
	...
	rm -rf $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)mysql5-test
	install -d $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)var/lib/mysql
	install -d $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)var/log
	install -d $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(MYSQL5_SOURCE_DIR)/my.cnf $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/my.cnf
	install -d $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	( cd $(MYSQL5_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d ; \
