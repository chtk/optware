...
#DANSGUARDIAN_CONFFILES=$(OPTWARE_PREFIX)etc/dansguardian.conf $(OPTWARE_PREFIX)etc/init.d/SXXdansguardian
...
#
# Binaries should be installed into $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/dansguardian/...
# Documentation files should be installed in $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)doc/dansguardian/...
# Daemon startup scripts should be installed in $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dansguardian
#
...
#	install -d $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(DANSGUARDIAN_SOURCE_DIR)/dansguardian.conf $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/dansguardian.conf
#	install -d $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(DANSGUARDIAN_SOURCE_DIR)/rc.dansguardian $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXdansguardian
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(DANSGUARDIAN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXdansguardian
