...
#AGET_CONFFILES=$(OPTWARE_PREFIX)etc/aget.conf $(OPTWARE_PREFIX)etc/init.d/SXXaget
...
#
# Binaries should be installed into $(AGET_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(AGET_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(AGET_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(AGET_IPK_DIR)$(OPTWARE_PREFIX)etc/aget/...
# Documentation files should be installed in $(AGET_IPK_DIR)$(OPTWARE_PREFIX)doc/aget/...
# Daemon startup scripts should be installed in $(AGET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??aget
#
