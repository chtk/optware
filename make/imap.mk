...
#
# Binaries should be installed into $(IMAP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IMAP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IMAP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IMAP_IPK_DIR)$(OPTWARE_PREFIX)etc/imap/...
# Documentation files should be installed in $(IMAP_IPK_DIR)$(OPTWARE_PREFIX)doc/imap/...
# Daemon startup scripts should be installed in $(IMAP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??imap
#
