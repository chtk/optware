...
#CLIPS_CONFFILES=$(OPTWARE_PREFIX)etc/clips.conf $(OPTWARE_PREFIX)etc/init.d/SXXclips
...
#
# Binaries should be installed into $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX)etc/clips/...
# Documentation files should be installed in $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX)doc/clips/...
# Daemon startup scripts should be installed in $(CLIPS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??clips
#
