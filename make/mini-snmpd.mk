...
#MINI-SNMPD_CONFFILES=$(OPTWARE_PREFIX)etc/mini-snmpd.conf $(OPTWARE_PREFIX)etc/init.d/SXXmini-snmpd
...
#
# Binaries should be installed into $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)etc/mini-snmpd/...
# Documentation files should be installed in $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)doc/mini-snmpd/...
# Daemon startup scripts should be installed in $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mini-snmpd
#
# You may need to patch your application to make it use these locations.
#
$(MINI-SNMPD_IPK): $(MINI-SNMPD_BUILD_DIR)/.built
	rm -rf $(MINI-SNMPD_IPK_DIR) $(BUILD_DIR)/mini-snmpd_*_$(TARGET_ARCH).ipk
	$(MAKE) -C $(MINI-SNMPD_BUILD_DIR) INSTALL_ROOT=$(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)install
	$(STRIP_COMMAND) $(MINI-SNMPD_IPK_DIR)$(OPTWARE_PREFIX)sbin/*
