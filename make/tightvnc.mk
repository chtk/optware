...
#TIGHTVNC_CONFFILES=$(OPTWARE_PREFIX)etc/tightvnc.conf $(OPTWARE_PREFIX)etc/init.d/SXXtightvnc
...
#
# Binaries should be installed into $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/tightvnc/...
# Documentation files should be installed in $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)doc/tightvnc/...
# Daemon startup scripts should be installed in $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??tightvnc
#
...
$(TIGHTVNC_IPK): $(TIGHTVNC_BUILD_DIR)/.built
	...
	( \
	    cd $(TIGHTVNC_BUILD_DIR); \
	    install -d $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)bin $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)man/man1; \
	    ./vncinstall $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)bin $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)man; \
	)
	#install -d $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/
	#install -m 644 $(TIGHTVNC_SOURCE_DIR)/tightvnc.conf $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/tightvnc.conf
	#install -d $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	#install -m 755 $(TIGHTVNC_SOURCE_DIR)/rc.tightvnc $(TIGHTVNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXtightvnc
