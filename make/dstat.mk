...
#DSTAT_CONFFILES=$(OPTWARE_PREFIX)etc/dstat.conf $(OPTWARE_PREFIX)etc/init.d/SXXdstat
...
#
# Binaries should be installed into $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX)etc/dstat/...
# Documentation files should be installed in $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX)doc/dstat/...
# Daemon startup scripts should be installed in $(DSTAT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dstat
#
