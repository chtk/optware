...
#
# Binaries should be installed into $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX)etc/ipkg-web/...
# Documentation files should be installed in $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX)doc/ipkg-web/...
# Daemon startup scripts should be installed in $(IPKG_WEB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ipkg-web
#
