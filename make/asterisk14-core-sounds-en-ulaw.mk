...
#
ASTERISK14_CORE_SOUNDS_EN_ULAW_SITE=http://downloads.asterisk.org/pub/telephony/sounds/releases
ASTERISK14_CORE_SOUNDS_EN_ULAW_VERSION=1.4.19
...
#ASTERISK14_CORE_SOUNDS_EN_ULAW_CONFFILES=$(OPTWARE_PREFIX)etc/asterisk14-core-sounds-en-ulaw.conf $(OPTWARE_PREFIX)etc/init.d/SXXasterisk14-core-sounds-en-ulaw
...
#
# Binaries should be installed into $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-core-sounds-en-ulaw/...
# Documentation files should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-core-sounds-en-ulaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-core-sounds-en-ulaw
#
...
$(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK): $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/.built
	...
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/dictate
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/dictate/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/dictate
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/digits
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/digits/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/digits
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/followme
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/followme/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/followme
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/letters
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/letters/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/letters
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/phonetic
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/phonetic/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/phonetic
	install -d $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/silence
	install -m 644 $(ASTERISK14_CORE_SOUNDS_EN_ULAW_BUILD_DIR)/silence/*.ulaw $(ASTERISK14_CORE_SOUNDS_EN_ULAW_IPK_DIR)$(OPTWARE_PREFIX)/var/lib/asterisk/sounds/silence
