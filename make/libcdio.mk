...
#LIBCDIO_CONFFILES=$(OPTWARE_PREFIX)etc/libcdio.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibcdio
...
#
# Binaries should be installed into $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/libcdio/...
# Documentation files should be installed in $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)doc/libcdio/...
# Daemon startup scripts should be installed in $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libcdio
#
...
#	install -d $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBCDIO_SOURCE_DIR)/libcdio.conf $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/libcdio.conf
#	install -d $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBCDIO_SOURCE_DIR)/rc.libcdio $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibcdio
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBCDIO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibcdio
