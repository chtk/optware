...
#SHNTOOL_CONFFILES=$(OPTWARE_PREFIX)etc/shntool.conf $(OPTWARE_PREFIX)etc/init.d/SXXshntool
...
#
# Binaries should be installed into $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/shntool/...
# Documentation files should be installed in $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)doc/shntool/...
# Daemon startup scripts should be installed in $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??shntool
#
...
#	install -d $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(SHNTOOL_SOURCE_DIR)/shntool.conf $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/shntool.conf
#	install -d $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(SHNTOOL_SOURCE_DIR)/rc.shntool $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXshntool
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SHNTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXshntool
