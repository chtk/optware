...
#LFTP_CONFFILES=$(OPTWARE_PREFIX)etc/lftp.conf $(OPTWARE_PREFIX)etc/init.d/SXXlftp
...
#
# Binaries should be installed into $(LFTP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LFTP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LFTP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/lftp/...
# Documentation files should be installed in $(LFTP_IPK_DIR)$(OPTWARE_PREFIX)doc/lftp/...
# Daemon startup scripts should be installed in $(LFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??lftp
#
