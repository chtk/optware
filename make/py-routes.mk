...
#PY-ROUTES_CONFFILES=$(OPTWARE_PREFIX)etc/py-routes.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-routes
...
#
# Binaries should be installed into $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX)etc/py-routes/...
# Documentation files should be installed in $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX)doc/py-routes/...
# Daemon startup scripts should be installed in $(PY-ROUTES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-routes
#
