...
#
JIKES_SITE=http://$(SOURCEFORGE_MIRROR)/sourceforge/jikes
JIKES_VERSION=1.22
...
#JIKES_CONFFILES=$(OPTWARE_PREFIX)etc/jikes.conf $(OPTWARE_PREFIX)etc/init.d/SXXjikes
...
#
# Binaries should be installed into $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(JIKES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)etc/jikes/...
# Documentation files should be installed in $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)doc/jikes/...
# Daemon startup scripts should be installed in $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??jikes
#
...
#	install -m 755 $(JIKES_SOURCE_DIR)/rc.jikes $(JIKES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXjikes
