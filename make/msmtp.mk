...
#MSMTP_CONFFILES=$(OPTWARE_PREFIX)etc/msmtp.conf $(OPTWARE_PREFIX)etc/init.d/SXXmsmtp
...
#
# Binaries should be installed into $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/msmtp/...
# Documentation files should be installed in $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)doc/msmtp/...
# Daemon startup scripts should be installed in $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??msmtp
#
...
#	install -d $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(MSMTP_SOURCE_DIR)/msmtp.conf $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/msmtp.conf
#	install -d $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(MSMTP_SOURCE_DIR)/rc.msmtp $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmsmtp
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(MSMTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmsmtp
