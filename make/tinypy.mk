...
#TINYPY_CONFFILES=$(OPTWARE_PREFIX)etc/tinypy.conf $(OPTWARE_PREFIX)etc/init.d/SXXtinypy
...
#
# Binaries should be installed into $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)etc/tinypy/...
# Documentation files should be installed in $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)doc/tinypy/...
# Daemon startup scripts should be installed in $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??tinypy
#
...
#	$(MAKE) -C $(TINYPY_BUILD_DIR) DESTDIR=$(TINYPY_IPK_DIR) install-strip
	install -d $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(TINYPY_BUILD_DIR)/build/tinypy -o $(TINYPY_IPK_DIR)$(OPTWARE_PREFIX)bin/tinypy
