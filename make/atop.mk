...
# ATOP_CONFFILES=$(OPTWARE_PREFIX)etc/atop.conf $(OPTWARE_PREFIX)etc/init.d/SXXatop
...
#
# Binaries should be installed into $(ATOP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ATOP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ATOP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ATOP_IPK_DIR)$(OPTWARE_PREFIX)etc/atop/...
# Documentation files should be installed in $(ATOP_IPK_DIR)$(OPTWARE_PREFIX)doc/atop/...
# Daemon startup scripts should be installed in $(ATOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??atop
#
