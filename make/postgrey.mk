...
#	$(MAKE) -C $(POSTGREY_BUILD_DIR) DESTDIR=$(POSTGREY_IPK_DIR) install
	install -d $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)sbin $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -m 755 $(POSTGREY_BUILD_DIR)/postgrey $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)sbin
	install -m 755 $(POSTGREY_BUILD_DIR)/contrib/postgreyreport $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -d $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)share/postgrey
	install $(POSTGREY_BUILD_DIR)/README* \
		...
		$(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)share/postgrey/
	install -d $(POSTGREY_IPK_DIR)$(OPTWARE_PREFIX)var/spool/postfix/postgrey
