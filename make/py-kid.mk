...
#PY-KID_CONFFILES=$(OPTWARE_PREFIX)etc/py-kid.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-kid
...
#
# Binaries should be installed into $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX)etc/py-kid/...
# Documentation files should be installed in $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX)doc/py-kid/...
# Daemon startup scripts should be installed in $(PY-KID_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-kid
#
...
$(PY24-KID_IPK) $(PY25-KID_IPK): $(PY-KID_BUILD_DIR)/.built
	...
	for f in $(PY24-KID_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
