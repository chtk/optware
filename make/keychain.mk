...
#KEYCHAIN_CONFFILES=$(OPTWARE_PREFIX)etc/keychain.conf $(OPTWARE_PREFIX)etc/init.d/SXXkeychain
...
#
# Binaries should be installed into $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX)etc/keychain/...
# Documentation files should be installed in $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX)doc/keychain/...
# Daemon startup scripts should be installed in $(KEYCHAIN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??keychain
#
