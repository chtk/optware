...
#DBUS-PYTHON_CONFFILES=$(OPTWARE_PREFIX)etc/dbus-python.conf $(OPTWARE_PREFIX)etc/init.d/SXXdbus-python
...
#
# Binaries should be installed into $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)etc/dbus-python/...
# Documentation files should be installed in $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)doc/dbus-python/...
# Daemon startup scripts should be installed in $(DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dbus-python
#
...
#	$(STRIP_COMMAND) $(PY25-DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/dbus-python/*.so
...
#	$(STRIP_COMMAND) $(PY26-DBUS-PYTHON_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/dbus-python/*.so
