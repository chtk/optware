...
#UPDATEDD_CONFFILES=$(OPTWARE_PREFIX)etc/updatedd.conf $(OPTWARE_PREFIX)etc/init.d/SXXupdatedd
...
#
# Binaries should be installed into $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX)etc/updatedd/...
# Documentation files should be installed in $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX)doc/updatedd/...
# Daemon startup scripts should be installed in $(UPDATEDD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??updatedd
#
