...
#
# Binaries should be installed into $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX)etc/xauth/...
# Documentation files should be installed in $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX)doc/xauth/...
# Daemon startup scripts should be installed in $(XAUTH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xauth
#
