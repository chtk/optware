...
#LIBLCMS_CONFFILES=$(OPTWARE_PREFIX)etc/liblcms.conf $(OPTWARE_PREFIX)etc/init.d/SXXliblcms
...
#
# Binaries should be installed into $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/liblcms/...
# Documentation files should be installed in $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)doc/liblcms/...
# Daemon startup scripts should be installed in $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??liblcms
#
...
#	install -d $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBLCMS_SOURCE_DIR)/liblcms.conf $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/liblcms.conf
#	install -d $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBLCMS_SOURCE_DIR)/rc.liblcms $(LIBLCMS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXliblcms
