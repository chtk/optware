...
#SIPCALC_CONFFILES=$(OPTWARE_PREFIX)etc/sipcalc.conf $(OPTWARE_PREFIX)etc/init.d/SXXsipcalc
...
#
# Binaries should be installed into $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)etc/sipcalc/...
# Documentation files should be installed in $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)doc/sipcalc/...
# Daemon startup scripts should be installed in $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??sipcalc
#
...
$(SIPCALC_IPK): $(SIPCALC_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SIPCALC_IPK_DIR)$(OPTWARE_PREFIX)bin/sipcalc
