...
#HD2U_CONFFILES=$(OPTWARE_PREFIX)etc/hd2u.conf $(OPTWARE_PREFIX)etc/init.d/SXXhd2u
...
#
# Binaries should be installed into $(HD2U_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HD2U_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HD2U_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HD2U_IPK_DIR)$(OPTWARE_PREFIX)etc/hd2u/...
# Documentation files should be installed in $(HD2U_IPK_DIR)$(OPTWARE_PREFIX)doc/hd2u/...
# Daemon startup scripts should be installed in $(HD2U_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??hd2u
#
