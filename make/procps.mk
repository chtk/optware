...
PROCPS_CPPFLAGS="$(STAGING_CPPFLAGS) -I$(STAGING_DIR)$(OPTWARE_PREFIX)include/ncurses"
...
$(PROCPS_IPK): $(PROCPS_BUILD_DIR)/.built
	...
	mkdir -p $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/free -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-free
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/kill -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-kill
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/pgrep -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/pgrep
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/pmap -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/pmap
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/ps/ps -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-ps
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/skill -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/skill
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/slabtop -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/slabtop
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/snice -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/snice
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/sysctl -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/sysctl
	cp $(PROCPS_BUILD_DIR)/t $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/tload -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/tload
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/top -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-top
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/uptime -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-uptime
	cp $(PROCPS_BUILD_DIR)/v $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/vmstat -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/vmstat
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/w -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/w
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/watch -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)bin/procps-watch
	mkdir -p $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)lib
	$(STRIP_COMMAND) $(PROCPS_BUILD_DIR)/proc/libproc-$(PROCPS_VERSION).so -o $(PROCPS_IPK_DIR)$(OPTWARE_PREFIX)lib/libproc-$(PROCPS_VERSION).so
