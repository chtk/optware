...
DOKUWIKI_VERSION=2010-11-07
DOKUWIKI_SOURCE=dokuwiki-$(DOKUWIKI_VERSION).tgz
DOKUWIKI_DIR=dokuwiki-2010-11-07
DOKUWIKI_UNZIP=zcat
...
#DOKUWIKI_CONFFILES=$(OPTWARE_PREFIX)etc/dokuwiki.conf $(OPTWARE_PREFIX)etc/init.d/SXXdokuwiki
...
$(DOKUWIKI_BUILD_DIR)/.configured: $(DL_DIR)/$(DOKUWIKI_SOURCE) $(DOKUWIKI_PATCHES)
	rm -rf $(BUILD_DIR)/$(DOKUWIKI_DIR) $(@D)
...
#
# Binaries should be installed into $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX)etc/dokuwiki/...
# Documentation files should be installed in $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX)doc/dokuwiki/...
# Daemon startup scripts should be installed in $(DOKUWIKI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dokuwiki
#
