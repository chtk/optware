...
GIMP-PRINT_CONFFILES=$(OPTWARE_PREFIX)etc/gimp-print.conf $(OPTWARE_PREFIX)etc/init.d/SXXgimp-print
...
#
# Binaries should be installed into $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX)etc/gimp-print/...
# Documentation files should be installed in $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX)doc/gimp-print/...
# Daemon startup scripts should be installed in $(GIMP-PRINT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gimp-print
#
