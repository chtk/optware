...
#PSMISC_CONFFILES=$(OPTWARE_PREFIX)etc/psmisc.conf $(OPTWARE_PREFIX)etc/init.d/SXXpsmisc
...
#
# Binaries should be installed into $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX)etc/psmisc/...
# Documentation files should be installed in $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX)doc/psmisc/...
# Daemon startup scripts should be installed in $(PSMISC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??psmisc
#
