...
#ZSH_CONFFILES=$(OPTWARE_PREFIX)etc/zsh.conf $(OPTWARE_PREFIX)etc/init.d/SXXzsh
...
#
# Binaries should be installed into $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ZSH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/zsh/...
# Documentation files should be installed in $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)doc/zsh/...
# Daemon startup scripts should be installed in $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??zsh
#
...
$(ZSH_IPK): $(ZSH_BUILD_DIR)/.built
	...
	rm -f $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)bin/zsh-[0-9]*
	$(STRIP_COMMAND) $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)bin/zsh
	install -d $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(ZSH_SOURCE_DIR)/zsh.conf $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/zsh.conf
#	install -d $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(ZSH_SOURCE_DIR)/rc.zsh $(ZSH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXzsh
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXzsh
