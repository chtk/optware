...
SER2NET_CONFFILES=$(OPTWARE_PREFIX)etc/ser2net.conf $(OPTWARE_PREFIX)etc/init.d/S95ser2net
...
#
# Binaries should be installed into $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/ser2net/...
# Documentation files should be installed in $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)doc/ser2net/...
# Daemon startup scripts should be installed in $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ser2net
#
...
$(SER2NET_IPK): $(SER2NET_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)sbin/ser2net
	install -d $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(SER2NET_BUILD_DIR)/ser2net.conf $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/ser2net.conf
	install -d $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -m 755 $(SER2NET_BUILD_DIR)/ser2net.init $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S95ser2net
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SER2NET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXser2net
