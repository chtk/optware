...
#CDPARANOIA_CONFFILES=$(OPTWARE_PREFIX)etc/cdparanoia.conf $(OPTWARE_PREFIX)etc/init.d/SXXcdparanoia
...
#
# Binaries should be installed into $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/cdparanoia/...
# Documentation files should be installed in $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)doc/cdparanoia/...
# Daemon startup scripts should be installed in $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cdparanoia
#
...
$(CDPARANOIA_IPK): $(CDPARANOIA_BUILD_DIR)/.built
	...
	install -d $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/
	install -m 644 $(CDPARANOIA_SOURCE_DIR)/cdparanoia.conf $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/cdparanoia.conf
	install -d $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	install -m 755 $(CDPARANOIA_SOURCE_DIR)/rc.cdparanoia $(CDPARANOIA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXcdparanoia
