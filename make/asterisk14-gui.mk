...
#
# Binaries should be installed into $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-gui/...
# Documentation files should be installed in $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-gui/...
# Daemon startup scripts should be installed in $(ASTERISK14_GUI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-gui
#
