...
#
# Binaries should be installed into $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/findutils/...
# Documentation files should be installed in $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/findutils/...
# Daemon startup scripts should be installed in $(FINDUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??findutils
#
