...
#LIBDB52_CONFFILES=$(OPTWARE_PREFIX)etc/libdb52.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibdb52
...
#	$(MAKE) <bar>-stage <baz>-stage
	...
	(cd $(@D)/build_unix; \
		...
		--includedir=$(OPTWARE_PREFIX)include/db5 \
		--enable-compat185 \
		$(LIBDB52_MUTEX) \
		--with-uniquename \
		--disable-nls \
...
#
# Binaries should be installed into $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)etc/libdb52/...
# Documentation files should be installed in $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)doc/libdb52/...
# Daemon startup scripts should be installed in $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libdb52
#
...
$(LIBDB52_IPK): $(LIBDB52_BUILD_DIR)/.built
	...
	$(MAKE) -C $(LIBDB52_BUILD_DIR)/build_unix DESTDIR=$(LIBDB52_IPK_DIR) \
		install_setup install_include install_lib # install_utilities
	$(STRIP_COMMAND) $(LIBDB52_IPK_DIR)$(OPTWARE_PREFIX)lib/libdb-5.2.so
