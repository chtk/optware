...
#PY-PYLONS_CONFFILES=$(OPTWARE_PREFIX)etc/py-pylons.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-pylons
...
#
# Binaries should be installed into $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)etc/py-pylons/...
# Documentation files should be installed in $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)doc/py-pylons/...
# Daemon startup scripts should be installed in $(PY-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-pylons
#
...
#	$(STRIP_COMMAND) `find $(PY25-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages -name '*.so'`
...
#	$(STRIP_COMMAND) `find $(PY26-PYLONS_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages -name '*.so'`
