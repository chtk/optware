...
P910ND_CONFFILES=$(OPTWARE_PREFIX)etc/p910nd $(OPTWARE_PREFIX)etc/init.d/S95p910nd
...
$(P910ND_BUILD_DIR)/.built: $(P910ND_BUILD_DIR)/.configured
	...
	$(MAKE) -C $(@D) \
		...
		CONFIGDIR=$(OPTWARE_PREFIX)etc \
		SCRIPTDIR=$(OPTWARE_PREFIX)etc/init.d \
...
#
# Binaries should be installed into $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(P910ND_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)etc/p910nd/...
# Documentation files should be installed in $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)doc/p910nd/...
# Daemon startup scripts should be installed in $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??p910nd
#
...
$(P910ND_IPK): $(P910ND_BUILD_DIR)/.built
	...
	$(MAKE) -C $(P910ND_BUILD_DIR) install \
		...
		MANDIR=$(OPTWARE_PREFIX)share/man/man8 \
		;
	$(STRIP_COMMAND) $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)bin/p910nd
	mv $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/p910nd $(P910ND_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S95p910nd
