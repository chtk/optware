...
#LIBINKLEVEL_CONFFILES=$(OPTWARE_PREFIX)etc/libinklevel.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibinklevel
...
#
# Binaries should be installed into $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/libinklevel/...
# Documentation files should be installed in $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)doc/libinklevel/...
# Daemon startup scripts should be installed in $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libinklevel
#
...
$(LIBINKLEVEL_IPK): $(LIBINKLEVEL_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)lib/libinklevel.so
#	install -d $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBINKLEVEL_SOURCE_DIR)/libinklevel.conf $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/libinklevel.conf
#	install -d $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBINKLEVEL_SOURCE_DIR)/rc.libinklevel $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibinklevel
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBINKLEVEL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibinklevel
