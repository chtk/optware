...
E2FSPROGS_CONFFILES=$(OPTWARE_PREFIX)etc/mke2fs.conf
...
#	cat $(E2FSPROGS_PATCHES) | patch -d $(BUILD_DIR)/$(E2FSPROGS_DIR) -p1
	...
	sed -i -e 's|(DESTDIR)/etc|(DESTDIR)$(OPTWARE_PREFIX)etc|g' $(@D)/misc/Makefile.in
	(cd $(@D); \
...
#
# Binaries should be installed into $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)etc/e2fsprogs/...
# Documentation files should be installed in $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)doc/e2fsprogs/...
# Daemon startup scripts should be installed in $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??e2fsprogs
#
...
$(E2FSPROGS_IPK) $(E2FSLIBS_IPK) $(E2FSLIBS-DEV_IPK): $(E2FSPROGS_BUILD_DIR)/.built
	...
	# We place files in $(OPTWARE_PREFIX)lib and $(OPTWARE_PREFIX)sbin only
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)etc
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)lib
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8
	install -d $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man1
	...
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/debugfs/debugfs -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/debugfs
	-$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/e2fsck/e2fsck.shared -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/e2fsck
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/resize/resize2fs -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/resize2fs
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/misc/tune2fs -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/tune2fs
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/misc/dumpe2fs -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/dumpe2fs
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/misc/chattr -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin/chattr
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/misc/lsattr -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin/lsattr
	$(STRIP_COMMAND) $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin/uuidgen $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)lib/e2initrd_helper
ifeq ($(OPTWARE_TARGET),ts72xx)
	$(STRIP_COMMAND) $(E2FSPROGS_BUILD_DIR)/misc/mke2fs -o $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/mke2fs
else
	rm -f $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/mke2fs
endif
	# e2fslibs
	install -d $(E2FSLIBS_IPK_DIR)$(OPTWARE_PREFIX)share
	mv $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)lib $(E2FSLIBS_IPK_DIR)$(OPTWARE_PREFIX)
	mv $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)share/info $(E2FSLIBS_IPK_DIR)$(OPTWARE_PREFIX)share/
	...
	rm -f $(E2FSLIBS-DEV_IPK_DIR)$(OPTWARE_PREFIX)lib/lib*
	$(MAKE) $(E2FSLIBS-DEV_IPK_DIR)/CONTROL/control
	cd $(BUILD_DIR); $(IPKG_BUILD) $(E2FSLIBS-DEV_IPK_DIR)
	# e2fsprogs
	install -m 644  $(E2FSPROGS_BUILD_DIR)/resize/resize2fs.8 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8/resize2fs.8
	install -m 644  $(E2FSPROGS_BUILD_DIR)/e2fsck/e2fsck.8 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8/e2fsck.8
	install -m 644  $(E2FSPROGS_BUILD_DIR)/debugfs/debugfs.8 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8/debugfs.8
	install -m 644  $(E2FSPROGS_BUILD_DIR)/misc/tune2fs.8 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8/tune2fs.8
	install -m 644  $(E2FSPROGS_BUILD_DIR)/misc/dumpe2fs.8 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man8/dumpe2fs.8
	install -m 644  $(E2FSPROGS_BUILD_DIR)/misc/lsattr.1 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man1/lsattr.1
	install -m 644  $(E2FSPROGS_BUILD_DIR)/misc/chattr.1 $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)man/man1/chattr.1
	# Package files
	...
	for f in chattr lsattr; do \
	    mv $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin/$$f $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)bin/e2fsprogs-$$f; \
	    echo "update-alternatives --install $(OPTWARE_PREFIX)bin/$$f $$f $(OPTWARE_PREFIX)bin/e2fsprogs-$$f 80" \
		>> $(E2FSPROGS_IPK_DIR)/CONTROL/postinst; \
	    echo "update-alternatives --remove $$f $(OPTWARE_PREFIX)bin/e2fsprogs-$$f" \
		>> $(E2FSPROGS_IPK_DIR)/CONTROL/prerm; \
	done
	for f in fsck; do \
	    mv $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/$$f $(E2FSPROGS_IPK_DIR)$(OPTWARE_PREFIX)sbin/e2fsprogs-$$f; \
	    echo "update-alternatives --install $(OPTWARE_PREFIX)sbin/$$f $$f $(OPTWARE_PREFIX)sbin/e2fsprogs-$$f 80" \
		>> $(E2FSPROGS_IPK_DIR)/CONTROL/postinst; \
	    echo "update-alternatives --remove $$f $(OPTWARE_PREFIX)sbin/e2fsprogs-$$f" \
		>> $(E2FSPROGS_IPK_DIR)/CONTROL/prerm; \
	done
