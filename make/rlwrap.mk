...
#RLWRAP_CONFFILES=$(OPTWARE_PREFIX)etc/rlwrap.conf $(OPTWARE_PREFIX)etc/init.d/SXXrlwrap
...
#
# Binaries should be installed into $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)etc/rlwrap/...
# Documentation files should be installed in $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)doc/rlwrap/...
# Daemon startup scripts should be installed in $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??rlwrap
#
...
$(RLWRAP_IPK): $(RLWRAP_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(RLWRAP_IPK_DIR)$(OPTWARE_PREFIX)bin/rlwrap
