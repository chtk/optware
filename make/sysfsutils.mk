...
#SYSFSUTILS_CONFFILES=$(OPTWARE_PREFIX)etc/sysfsutils.conf $(OPTWARE_PREFIX)etc/init.d/SXXsysfsutils
...
#
# Binaries should be installed into $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/sysfsutils/...
# Documentation files should be installed in $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/sysfsutils/...
# Daemon startup scripts should be installed in $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??sysfsutils
#
...
$(SYSFSUTILS_IPK): $(SYSFSUTILS_BUILD_DIR)/.built
	...
	rm -f $(SYSFSUTILS_IPK_DIR)$(OPTWARE_PREFIX)lib/libsysfs*.la
