...
#SURFRAW_CONFFILES=$(OPTWARE_PREFIX)etc/surfraw.conf $(OPTWARE_PREFIX)etc/init.d/SXXsurfraw
...
#
# Binaries should be installed into $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/surfraw/...
# Documentation files should be installed in $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)doc/surfraw/...
# Daemon startup scripts should be installed in $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??surfraw
#
...
$(SURFRAW_IPK): $(SURFRAW_BUILD_DIR)/.built
	...
	sed -i -e '/^#!\/usr\/bin\/perl/s|/usr/|$(OPTWARE_PREFIX)|' $(SURFRAW_IPK_DIR)$(OPTWARE_PREFIX)bin/*
