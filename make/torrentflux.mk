...
TORRENTFLUX_INSTALL_DIR=$(OPTWARE_PREFIX)share/www/torrentflux
...
#
# Binaries should be installed into $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)etc/torrentflux/...
# Documentation files should be installed in $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux/...
# Daemon startup scripts should be installed in $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??torrentflux
#
...
$(TORRENTFLUX_IPK): $(TORRENTFLUX_BUILD_DIR)/.built
	...
	install -d $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_BUILD_DIR)/README $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_BUILD_DIR)/COPYING $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_BUILD_DIR)/CHANGELOG $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_BUILD_DIR)/INSTALL $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_SOURCE_DIR)/README.Optware $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -m 755 $(TORRENTFLUX_SOURCE_DIR)/sqlite_torrentflux.sql $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)doc/torrentflux
	install -d $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)var/torrentflux/db
	install -d $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)var/torrentflux/downloads
	install -m 755 $(TORRENTFLUX_BUILD_DIR)/html/downloads/index.html $(TORRENTFLUX_IPK_DIR)$(OPTWARE_PREFIX)var/torrentflux/downloads
