...
#TS209-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/ts209-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXts209-kernel-modules
...
#
# Binaries should be installed into $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/ts209-kernel-modules/...
# Documentation files should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/ts209-kernel-modules/...
# Daemon startup scripts should be installed in $(TS209-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ts209-kernel-modules
#
