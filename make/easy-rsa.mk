...
#EASY-RSA_CONFFILES=$(OPTWARE_PREFIX)etc/easy-rsa.conf $(OPTWARE_PREFIX)etc/init.d/SXXeasy-rsa
...
#
# Binaries should be installed into $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX)etc/easy-rsa/...
# Documentation files should be installed in $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX)doc/easy-rsa/...
# Daemon startup scripts should be installed in $(EASY-RSA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??easy-rsa
#
