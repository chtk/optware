...
#LIBRSYNC_CONFFILES=$(OPTWARE_PREFIX)etc/librsync.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibrsync
...
#
# Binaries should be installed into $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/librsync/...
# Documentation files should be installed in $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)doc/librsync/...
# Daemon startup scripts should be installed in $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??librsync
#
...
$(LIBRSYNC_IPK): $(LIBRSYNC_BUILD_DIR)/.built
	...
	rm -f $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
#	install -d $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBRSYNC_SOURCE_DIR)/librsync.conf $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/librsync.conf
#	install -d $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBRSYNC_SOURCE_DIR)/rc.librsync $(LIBRSYNC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibrsync
