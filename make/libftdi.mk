...
$(LIBFTDI_BUILD_DIR)/.configured: $(DL_DIR)/$(LIBFTDI_SOURCE) $(LIBFTDI_PATCHES)
	...
	(cd $(LIBFTDI_BUILD_DIR); \
		...
		PATH=staging$(OPTWARE_PREFIX)bin/:$(PATH) \
...
#
# Binaries should be installed into $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)etc/libftdi/...
# Documentation files should be installed in $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)doc/libftdi/...
# Daemon startup scripts should be installed in $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libftdi
#
...
$(LIBFTDI_IPK): $(LIBFTDI_BUILD_DIR)/.built
	...
	rm -f $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)lib/libftdi.la
	$(STRIP_COMMAND) $(LIBFTDI_IPK_DIR)$(OPTWARE_PREFIX)lib/*.so.?.*
