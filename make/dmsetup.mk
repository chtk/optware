...
#DMSETUP_CONFFILES=$(OPTWARE_PREFIX)etc/dmsetup.conf $(OPTWARE_PREFIX)etc/init.d/SXXdmsetup
...
#
# Binaries should be installed into $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX)etc/dmsetup/...
# Documentation files should be installed in $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX)doc/dmsetup/...
# Daemon startup scripts should be installed in $(DMSETUP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dmsetup
#
