...
#TAGLIB_CONFFILES=$(OPTWARE_PREFIX)etc/taglib.conf $(OPTWARE_PREFIX)etc/init.d/SXXtaglib
...
#
# Binaries should be installed into $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/taglib/...
# Documentation files should be installed in $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)doc/taglib/...
# Daemon startup scripts should be installed in $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??taglib
#
...
#	install -d $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(TAGLIB_SOURCE_DIR)/taglib.conf $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/taglib.conf
#	install -d $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(TAGLIB_SOURCE_DIR)/rc.taglib $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXtaglib
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(TAGLIB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXtaglib
