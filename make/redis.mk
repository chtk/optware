...
#REDIS_CONFFILES=$(OPTWARE_PREFIX)etc/redis.conf $(OPTWARE_PREFIX)etc/init.d/SXXredis
...
#
# Binaries should be installed into $(REDIS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(REDIS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(REDIS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(REDIS_IPK_DIR)$(OPTWARE_PREFIX)etc/redis/...
# Documentation files should be installed in $(REDIS_IPK_DIR)$(OPTWARE_PREFIX)doc/redis/...
# Daemon startup scripts should be installed in $(REDIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??redis
#
