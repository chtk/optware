...
#PY-GNOSIS-UTILS_CONFFILES=$(OPTWARE_PREFIX)etc/py-gnosis-utils.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-gnosis-utils
...
#
# Binaries should be installed into $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/py-gnosis-utils/...
# Documentation files should be installed in $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/py-gnosis-utils/...
# Daemon startup scripts should be installed in $(PY-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-gnosis-utils
#
...
#	for f in $(PY25-GNOSIS-UTILS_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
