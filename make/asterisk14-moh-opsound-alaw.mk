...
#ASTERISK14_MOH_OPSOUND_ALAW_CONFFILES=$(OPTWARE_PREFIX)etc/asterisk14-moh-opsound-alaw.conf $(OPTWARE_PREFIX)etc/init.d/SXXasterisk14-moh-opsound-alaw
...
#
# Binaries should be installed into $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-moh-opsound-alaw/...
# Documentation files should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-moh-opsound-alaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-moh-opsound-alaw
#
...
$(ASTERISK14_MOH_OPSOUND_ALAW_IPK): $(ASTERISK14_MOH_OPSOUND_ALAW_BUILD_DIR)/.built
	...
	install -d $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/moh
	install -m 644 $(ASTERISK14_MOH_OPSOUND_ALAW_BUILD_DIR)/*alaw $(ASTERISK14_MOH_OPSOUND_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/moh
