...
#
# Binaries should be installed into $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)etc/unslung-feeds/...
# Documentation files should be installed in $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)doc/unslung-feeds/...
# Daemon startup scripts should be installed in $(UNSLUNG-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??unslung-feeds
#
