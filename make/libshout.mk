...
#LIBSHOUT_CONFFILES=$(OPTWARE_PREFIX)etc/libshout.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibshout
...
#
# Binaries should be installed into $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/libshout/...
# Documentation files should be installed in $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)doc/libshout/...
# Daemon startup scripts should be installed in $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libshout
#
...
#	install -d $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBSHOUT_SOURCE_DIR)/libshout.conf $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/libshout.conf
#	install -d $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBSHOUT_SOURCE_DIR)/rc.libshout $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibshout
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBSHOUT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibshout
