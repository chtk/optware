...
ASTERISK16_ADDONS_VERSION=1.6.2.4
...
ASTERISK16_ADDONS_MAINTAINER=Ovidiu Sas <osas@voipembedded.com>
ASTERISK16_ADDONS_DESCRIPTION=Asterisk extras
...
$(ASTERISK16_ADDONS_BUILD_DIR)/.configured: $(DL_DIR)/$(ASTERISK16_ADDONS_SOURCE) $(ASTERISK16_ADDONS_PATCHES) make/asterisk16-addons.mk
	...
	echo "MENUSELECT_APPS=" > $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
	echo "MENUSELECT_CDR=" >> $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
	echo "MENUSELECT_CHANNELS=chan_ooh323" >> $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
	echo "MENUSELECT_FORMATS=" >> $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
	echo "MENUSELECT_RES=" >> $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
	echo "MENUSELECT_BUILD_DEPS=" >> $(ASTERISK16_ADDONS_BUILD_DIR)/menuselect.makeopts
