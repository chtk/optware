...
#PY-HGSVN_CONFFILES=$(OPTWARE_PREFIX)etc/py-hgsvn.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-hgsvn
...
#
# Binaries should be installed into $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)etc/py-hgsvn/...
# Documentation files should be installed in $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)doc/py-hgsvn/...
# Daemon startup scripts should be installed in $(PY-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-hgsvn
#
...
$(PY26-HGSVN_IPK): $(PY-HGSVN_BUILD_DIR)/.built
	...
	for f in $(PY26-HGSVN_IPK_DIR)$(OPTWARE_PREFIX)bin/*; \
