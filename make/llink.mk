...
LLINK_CONFFILES=$(OPTWARE_PREFIX)share/llink/llink.conf $(OPTWARE_PREFIX)share/llink/jukebox.conf
...
#
# Binaries should be installed into $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LLINK_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/llink/...
# Documentation files should be installed in $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)doc/llink/...
# Daemon startup scripts should be installed in $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??llink
#
...
$(LLINK_IPK) $(LLINK-DEV_IPK): $(LLINK_BUILD_DIR)/.built
	...
	install -d $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/llink
	mv $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)bin/* $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/llink
	rm -rf $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)bin
	cp -a $(LLINK_BUILD_DIR)/src/skin $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/llink/
	cp -p $(LLINK_BUILD_DIR)/src/*.conf $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/llink/
	install -d $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/doc/llink
	install \
		$(LLINK_BUILD_DIR)/LICENSE \
		$(LLINK_BUILD_DIR)/README.txt \
		$(LLINK_BUILD_DIR)/Example* \
		$(LLINK_IPK_DIR)$(OPTWARE_PREFIX)share/doc/llink/
	install -d $(LLINK-DEV_IPK_DIR)/opt
	mv $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)include $(LLINK-DEV_IPK_DIR)/opt
	mv $(LLINK_IPK_DIR)$(OPTWARE_PREFIX)lib $(LLINK-DEV_IPK_DIR)/opt
