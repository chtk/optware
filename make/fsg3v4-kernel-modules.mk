...
#
FSG3V4-KERNEL-MODULES_IPK_VERSION=5

#
# FSG3V4-KERNEL-MODULES_CONFFILES should be a list of user-editable files
#FSG3V4-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/fsg3v4-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXfsg3v4-kernel-modules
...
#
# Binaries should be installed into $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/fsg3v4-kernel-modules/...
# Documentation files should be installed in $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/fsg3v4-kernel-modules/...
# Daemon startup scripts should be installed in $(FSG3V4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fsg3v4-kernel-modules
#
