...
#GNUPG_CONFFILES=$(OPTWARE_PREFIX)etc/gnupg.conf $(OPTWARE_PREFIX)etc/init.d/SXXgnupg
...
#
# Binaries should be installed into $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX)etc/gnupg/...
# Documentation files should be installed in $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX)doc/gnupg/...
# Daemon startup scripts should be installed in $(GNUPG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gnupg
#
