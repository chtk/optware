...
#DTACH_CONFFILES=$(OPTWARE_PREFIX)etc/dtach.conf $(OPTWARE_PREFIX)etc/init.d/SXXdtach
...
#
# Binaries should be installed into $(DTACH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DTACH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DTACH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DTACH_IPK_DIR)$(OPTWARE_PREFIX)etc/dtach/...
# Documentation files should be installed in $(DTACH_IPK_DIR)$(OPTWARE_PREFIX)doc/dtach/...
# Daemon startup scripts should be installed in $(DTACH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dtach
#
