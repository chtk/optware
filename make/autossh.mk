...
#AUTOSSH_CONFFILES=$(OPTWARE_PREFIX)etc/autossh.conf $(OPTWARE_PREFIX)etc/init.d/SXXautossh
...
#
# Binaries should be installed into $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX)etc/autossh/...
# Documentation files should be installed in $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX)doc/autossh/...
# Daemon startup scripts should be installed in $(AUTOSSH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??autossh
#
