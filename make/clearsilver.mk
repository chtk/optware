...
#CLEARSILVER_CONFFILES=$(OPTWARE_PREFIX)etc/clearsilver.conf $(OPTWARE_PREFIX)etc/init.d/SXXclearsilver
...
#
# Binaries should be installed into $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)etc/clearsilver/...
# Documentation files should be installed in $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)doc/clearsilver/...
# Daemon startup scripts should be installed in $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??clearsilver
#
...
#	install -m 755 $(CLEARSILVER_SOURCE_DIR)/rc.clearsilver $(CLEARSILVER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXclearsilver
