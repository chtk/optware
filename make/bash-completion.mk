...
#BASH_COMPLETION_CONFFILES=$(OPTWARE_PREFIX)etc/bash-completion.conf $(OPTWARE_PREFIX)etc/init.d/SXXbash-completion
...
#
# Binaries should be installed into $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX)etc/bash-completion/...
# Documentation files should be installed in $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX)doc/bash-completion/...
# Daemon startup scripts should be installed in $(BASH_COMPLETION_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bash-completion
#
