...
#NEMESIS_CONFFILES=$(OPTWARE_PREFIX)etc/nemesis.conf $(OPTWARE_PREFIX)etc/init.d/SXXnemesis
...
#
# Binaries should be installed into $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/nemesis/...
# Documentation files should be installed in $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)doc/nemesis/...
# Daemon startup scripts should be installed in $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??nemesis
#
...
#	install -d $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(NEMESIS_SOURCE_DIR)/nemesis.conf $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/nemesis.conf
#	install -d $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(NEMESIS_SOURCE_DIR)/rc.nemesis $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXnemesis
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(NEMESIS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXnemesis
