...
#IPUTILS_ARPING_CONFFILES=$(OPTWARE_PREFIX)etc/iputils-arping.conf $(OPTWARE_PREFIX)etc/init.d/SXXiputils-arping
...
#
# Binaries should be installed into $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)etc/iputils-arping/...
# Documentation files should be installed in $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)doc/iputils-arping/...
# Daemon startup scripts should be installed in $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??iputils-arping
#
...
$(IPUTILS_ARPING_IPK): $(IPUTILS_ARPING_BUILD_DIR)/.built
	...
	install -d $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)bin
	install $(IPUTILS_ARPING_BUILD_DIR)/arping $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)bin/
	$(STRIP_COMMAND) $(IPUTILS_ARPING_IPK_DIR)$(OPTWARE_PREFIX)bin/arping
