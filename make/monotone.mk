...
#MONOTONE_CONFFILES=$(OPTWARE_PREFIX)etc/monotone.conf $(OPTWARE_PREFIX)etc/init.d/SXXmonotone
...
#
# Binaries should be installed into $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)etc/monotone/...
# Documentation files should be installed in $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)doc/monotone/...
# Daemon startup scripts should be installed in $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??monotone
#
...
$(MONOTONE_IPK): $(MONOTONE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(MONOTONE_IPK_DIR)$(OPTWARE_PREFIX)bin/monotone
