...
#PY-APSW_CONFFILES=$(OPTWARE_PREFIX)etc/py-apsw.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-apsw
...
#
# Binaries should be installed into $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX)etc/py-apsw/...
# Documentation files should be installed in $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX)doc/py-apsw/...
# Daemon startup scripts should be installed in $(PY-APSW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-apsw
#
...
$(PY24-APSW_IPK): $(PY-APSW_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-APSW_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/apsw.so
...
$(PY25-APSW_IPK): $(PY-APSW_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY25-APSW_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/apsw.so
