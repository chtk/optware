...
#LAUNCHTOOL_CONFFILES=$(OPTWARE_PREFIX)etc/launchtool.conf $(OPTWARE_PREFIX)etc/init.d/SXXlaunchtool
...
#
# Binaries should be installed into $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/launchtool/...
# Documentation files should be installed in $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)doc/launchtool/...
# Daemon startup scripts should be installed in $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??launchtool
#
...
#	install -m 755 $(LAUNCHTOOL_SOURCE_DIR)/rc.launchtool $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlaunchtool
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LAUNCHTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlaunchtool
