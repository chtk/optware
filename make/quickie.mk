...
#QUICKIE_CONFFILES=$(OPTWARE_PREFIX)etc/quickie.conf $(OPTWARE_PREFIX)etc/init.d/SXXquickie
...
#
# Binaries should be installed into $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/quickie/...
# Documentation files should be installed in $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)doc/quickie/...
# Daemon startup scripts should be installed in $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??quickie
#
...
$(QUICKIE_IPK): $(QUICKIE_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)bin/*
#	install -d $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(QUICKIE_SOURCE_DIR)/quickie.conf $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/quickie.conf
#	install -d $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(QUICKIE_SOURCE_DIR)/rc.quickie $(QUICKIE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXquickie
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXquickie
