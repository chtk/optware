...
#SRECORD_CONFFILES=$(OPTWARE_PREFIX)etc/srecord.conf $(OPTWARE_PREFIX)etc/init.d/SXXsrecord
...
#
# Binaries should be installed into $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)etc/srecord/...
# Documentation files should be installed in $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)doc/srecord/...
# Daemon startup scripts should be installed in $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??srecord
#
...
$(SRECORD_IPK): $(SRECORD_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(SRECORD_IPK_DIR)$(OPTWARE_PREFIX)bin/srec_*
