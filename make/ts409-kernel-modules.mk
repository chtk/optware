...
#TS409-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/ts409-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXts409-kernel-modules
...
#
# Binaries should be installed into $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/ts409-kernel-modules/...
# Documentation files should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/ts409-kernel-modules/...
# Daemon startup scripts should be installed in $(TS409-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ts409-kernel-modules
#
