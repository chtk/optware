...
#
# Binaries should be installed into $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)etc/wiley-feeds/...
# Documentation files should be installed in $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)doc/wiley-feeds/...
# Daemon startup scripts should be installed in $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??wiley-feeds
#
...
$(WILEY-FEEDS_IPK): $(WILEY-FEEDS_BUILD_DIR)/.built
	...
	install -d $(WILEY-FEEDS_IPK_DIR)$(OPTWARE_PREFIX)etc
