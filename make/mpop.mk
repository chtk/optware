...
#MPOP_CONFFILES=$(OPTWARE_PREFIX)etc/mpop.conf $(OPTWARE_PREFIX)etc/init.d/SXXmpop
...
#
# Binaries should be installed into $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MPOP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/mpop/...
# Documentation files should be installed in $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)doc/mpop/...
# Daemon startup scripts should be installed in $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mpop
#
...
#	install -d $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(MPOP_SOURCE_DIR)/mpop.conf $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/mpop.conf
#	install -d $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(MPOP_SOURCE_DIR)/rc.mpop $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmpop
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(MPOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmpop
