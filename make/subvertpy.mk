...
#SUBVERTPY_CONFFILES=$(OPTWARE_PREFIX)etc/subvertpy.conf $(OPTWARE_PREFIX)etc/init.d/SXXsubvertpy
...
#
# Binaries should be installed into $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)etc/subvertpy/...
# Documentation files should be installed in $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)doc/subvertpy/...
# Daemon startup scripts should be installed in $(SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??subvertpy
#
...
$(PY25-SUBVERTPY_IPK): $(SUBVERTPY_BUILD_DIR)/.built
	...
	for f in $(PY25-SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
		do mv $$f `echo $$f | sed 's|$$|-py2.5|'`; done
	$(STRIP_COMMAND) $(PY25-SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/subvertpy/*.so
...
$(PY26-SUBVERTPY_IPK): $(SUBVERTPY_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY26-SUBVERTPY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/subvertpy/*.so
