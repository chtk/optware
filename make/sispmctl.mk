...
#SISPMCTL_CONFFILES=$(OPTWARE_PREFIX)etc/sispmctl.conf $(OPTWARE_PREFIX)etc/init.d/SXXsispmctl
...
#
# Binaries should be installed into $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/sispmctl/...
# Documentation files should be installed in $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)doc/sispmctl/...
# Daemon startup scripts should be installed in $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??sispmctl
#
...
$(SISPMCTL_IPK): $(SISPMCTL_BUILD_DIR)/.built
	...
	install -d $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/
	# install -m 644 $(SISPMCTL_SOURCE_DIR)/sispmctl.conf $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/sispmctl.conf
	# install -d $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	# install -m 755 $(SISPMCTL_SOURCE_DIR)/rc.sispmctl $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXsispmctl
	# sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SISPMCTL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXsispmctl
