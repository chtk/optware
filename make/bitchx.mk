...
# BITCHX_CONFFILES=$(OPTWARE_PREFIX)etc/bitchx.conf $(OPTWARE_PREFIX)etc/init.d/SXXbitchx
...
#
# Binaries should be installed into $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)etc/bitchx/...
# Documentation files should be installed in $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)doc/bitchx/...
# Daemon startup scripts should be installed in $(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bitchx
#
# You may need to patch your application to make it use these locations.
#
$(BITCHX_IPK): $(BITCHX_BUILD_DIR)/.built
	rm -rf $(BITCHX_IPK_DIR) $(BUILD_DIR)/bitchx_*_$(TARGET_ARCH).ipk
	$(MAKE) -C $(BITCHX_BUILD_DIR) DESTDIR=$(BITCHX_IPK_DIR) prefix=$(BITCHX_IPK_DIR)$(OPTWARE_PREFIX)install
