...
#
# Binaries should be installed into $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX)etc/libol/...
# Documentation files should be installed in $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX)doc/libol/...
# Daemon startup scripts should be installed in $(LIBOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libol
#
