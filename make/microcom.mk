...
#MICROCOM_CONFFILES=$(OPTWARE_PREFIX)etc/microcom.conf $(OPTWARE_PREFIX)etc/init.d/SXXmicrocom
...
#
# Binaries should be installed into $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)etc/microcom/...
# Documentation files should be installed in $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)doc/microcom/...
# Daemon startup scripts should be installed in $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??microcom
#
...
#	$(MAKE) -C $(MICROCOM_BUILD_DIR) DESTDIR=$(MICROCOM_IPK_DIR) install-strip
	install -d $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)bin
	install $(MICROCOM_BUILD_DIR)/microcom $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)bin/microcom
#	install -d $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(MICROCOM_SOURCE_DIR)/microcom.conf $(MICROCOM_IPK_DIR)$(OPTWARE_PREFIX)etc/microcom.conf
