...
#PY-SILVERCITY_CONFFILES=$(OPTWARE_PREFIX)etc/py-silvercity.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-silvercity
...
#
# Binaries should be installed into $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)etc/py-silvercity/...
# Documentation files should be installed in $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)doc/py-silvercity/...
# Daemon startup scripts should be installed in $(PY-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-silvercity
#
...
$(PY24-SILVERCITY_IPK) $(PY25-SILVERCITY_IPK): $(PY-SILVERCITY_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(PY24-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/SilverCity/*.so
	for f in $(PY24-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
	...
	$(STRIP_COMMAND) $(PY25-SILVERCITY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/SilverCity/*.so
