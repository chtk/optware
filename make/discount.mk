...
#DISCOUNT_CONFFILES=$(OPTWARE_PREFIX)etc/discount.conf $(OPTWARE_PREFIX)etc/init.d/SXXdiscount
...
#
# Binaries should be installed into $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX)etc/discount/...
# Documentation files should be installed in $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX)doc/discount/...
# Daemon startup scripts should be installed in $(DISCOUNT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??discount
#
