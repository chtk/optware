...
#XMLRPC-C_CONFFILES=$(OPTWARE_PREFIX)etc/xmlrpc-c.conf $(OPTWARE_PREFIX)etc/init.d/SXXxmlrpc-c
...
#
# Binaries should be installed into $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)etc/xmlrpc-c/...
# Documentation files should be installed in $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)doc/xmlrpc-c/...
# Daemon startup scripts should be installed in $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xmlrpc-c
#
...
$(XMLRPC-C_IPK): $(XMLRPC-C_BUILD_DIR)/.built
	...
	rm -f $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)lib/*.a $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
	$(STRIP_COMMAND) $(XMLRPC-C_IPK_DIR)$(OPTWARE_PREFIX)lib/libxmlrpc*.so.[0-9]*.*
