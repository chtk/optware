...
#ADDUSER_CONFFILES=$(OPTWARE_PREFIX)etc/adduser.conf $(OPTWARE_PREFIX)etc/init.d/SXXadduser
...
#
# Binaries should be installed into $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX)etc/adduser/...
# Documentation files should be installed in $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX)doc/adduser/...
# Daemon startup scripts should be installed in $(ADDUSER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??adduser
#
