...
#PY-CTYPES_CONFFILES=$(OPTWARE_PREFIX)etc/py-ctypes.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-ctypes
...
#
# Binaries should be installed into $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)etc/py-ctypes/...
# Documentation files should be installed in $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)doc/py-ctypes/...
# Daemon startup scripts should be installed in $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-ctypes
#
...
#	$(STRIP_COMMAND) $(PY-CTYPES_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages/ctypes/*.so
