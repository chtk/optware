...
PHPMYADMIN_INSTALL_DIR=$(OPTWARE_PREFIX)share/www/phpmyadmin
...
$(DL_DIR)/$(PHPMYADMIN_SOURCE):
	...
	$(WGET) -P $(DL_DIR) $(SOURCES_NLO_SITE)/$(PHPMYADMIN_SOURCE)
...
#
# Binaries should be installed into $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX)etc/phpmyadmin/...
# Documentation files should be installed in $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX)doc/phpmyadmin/...
# Daemon startup scripts should be installed in $(PHPMYADMIN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??phpmyadmin
#
