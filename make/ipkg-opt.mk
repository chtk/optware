...
#
# Binaries should be installed into $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX)etc/ipkg/...
# Documentation files should be installed in $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX)doc/ipkg-opt/...
# Daemon startup scripts should be installed in $(IPKG-OPT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ipkg
#
