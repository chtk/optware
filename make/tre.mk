...
#TRE_CONFFILES=$(OPTWARE_PREFIX)etc/tre.conf $(OPTWARE_PREFIX)etc/init.d/SXXtre
...
#
# Binaries should be installed into $(TRE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TRE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TRE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TRE_IPK_DIR)$(OPTWARE_PREFIX)etc/tre/...
# Documentation files should be installed in $(TRE_IPK_DIR)$(OPTWARE_PREFIX)doc/tre/...
# Daemon startup scripts should be installed in $(TRE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??tre
#
...
$(TRE_IPK): $(TRE_BUILD_DIR)/.built
	...
	rm -f $(TRE_IPK_DIR)$(OPTWARE_PREFIX)lib/libtre.la
