...
#
# Binaries should be installed into $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX)etc/eventlog/...
# Documentation files should be installed in $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX)doc/eventlog/...
# Daemon startup scripts should be installed in $(EVENTLOG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??eventlog
#
