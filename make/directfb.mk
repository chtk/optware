...
#DIRECTFB_CONFFILES=$(OPTWARE_PREFIX)etc/directfb.conf $(OPTWARE_PREFIX)etc/init.d/SXXdirectfb
...
#
# Binaries should be installed into $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX)etc/directfb/...
# Documentation files should be installed in $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX)doc/directfb/...
# Daemon startup scripts should be installed in $(DIRECTFB_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??directfb
#
