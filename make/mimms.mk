...
#MIMMS_CONFFILES=$(OPTWARE_PREFIX)etc/mimms.conf $(OPTWARE_PREFIX)etc/init.d/SXXmimms
...
$(MIMMS_BUILD_DIR)/.configured: $(DL_DIR)/$(MIMMS_SOURCE) $(MIMMS_PATCHES) make/mimms.mk
	...
	sed -i -e 's|/usr/|$(OPTWARE_PREFIX)|g' $(MIMMS_BUILD_DIR)/Makefile
#	(cd $(MIMMS_BUILD_DIR); \
...
#
# Binaries should be installed into $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)etc/mimms/...
# Documentation files should be installed in $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)doc/mimms/...
# Daemon startup scripts should be installed in $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mimms
#
...
$(MIMMS_IPK): $(MIMMS_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(MIMMS_IPK_DIR)$(OPTWARE_PREFIX)bin/mimms
