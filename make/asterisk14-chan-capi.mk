...
#
# Binaries should be installed into $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-chan-capi/...
# Documentation files should be installed in $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-chan-capi/...
# Daemon startup scripts should be installed in $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-chan-capi
#
...
$(ASTERISK14-CHAN-CAPI_IPK): $(ASTERISK14-CHAN-CAPI_BUILD_DIR)/.built
	...
	$(MAKE) -C $(ASTERISK14-CHAN-CAPI_BUILD_DIR) install \
		MODULES_DIR=$(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)/lib/asterisk/modules \
		ASTERISK_HEADER_DIR=$(STAGING_INCLUDE_DIR) \
		;
	$(STRIP_COMMAND) $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)/lib/asterisk/modules/*.so
	install -d $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)/etc/asterisk/sample/
	install -m 644 $(ASTERISK14-CHAN-CAPI_BUILD_DIR)/capi.conf $(ASTERISK14-CHAN-CAPI_IPK_DIR)$(OPTWARE_PREFIX)/etc/asterisk/sample/capi.conf
