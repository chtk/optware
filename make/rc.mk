...
#RC_CONFFILES=$(OPTWARE_PREFIX)etc/rc.conf $(OPTWARE_PREFIX)etc/init.d/SXXrc
...
#
# Binaries should be installed into $(RC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(RC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(RC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/rc/...
# Documentation files should be installed in $(RC_IPK_DIR)$(OPTWARE_PREFIX)doc/rc/...
# Daemon startup scripts should be installed in $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??rc
#
...
#	install -d $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(RC_SOURCE_DIR)/rc.conf $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/rc.conf
#	install -d $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(RC_SOURCE_DIR)/rc.rc $(RC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXrc
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXrc
