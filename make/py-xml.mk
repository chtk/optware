...
#PY-XML_CONFFILES=$(OPTWARE_PREFIX)etc/py-xml.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-xml
...
#
# Binaries should be installed into $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX)etc/py-xml/...
# Documentation files should be installed in $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX)doc/py-xml/...
# Daemon startup scripts should be installed in $(PY-XML_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-xml
#
...
$(PY24-XML_IPK): $(PY-XML_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) `find $(PY24-XML_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.4/site-packages -name '*.so'`
...
$(PY25-XML_IPK): $(PY-XML_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) `find $(PY25-XML_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages -name '*.so'`
	$(MAKE) $(PY25-XML_IPK_DIR)/CONTROL/control
	for f in $(PY25-XML_IPK_DIR)$(OPTWARE_PREFIX)bin/*; \
