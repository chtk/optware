...
#UNCIA_CONFFILES=$(OPTWARE_PREFIX)etc/uncia.conf $(OPTWARE_PREFIX)etc/init.d/SXXuncia
...
#
# Binaries should be installed into $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX)etc/uncia/...
# Documentation files should be installed in $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX)doc/uncia/...
# Daemon startup scripts should be installed in $(UNCIA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??uncia
#
