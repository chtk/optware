...
MEDIAWIKI_INSTALL_DIR=$(OPTWARE_PREFIX)share/www/mediawiki
...
#
# Binaries should be installed into $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX)etc/mediawiki/...
# Documentation files should be installed in $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX)doc/mediawiki/...
# Daemon startup scripts should be installed in $(MEDIAWIKI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mediawiki
#
