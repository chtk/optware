...
#JED_CONFFILES=$(OPTWARE_PREFIX)etc/jed.conf $(OPTWARE_PREFIX)etc/init.d/SXXjed
...
#
# Binaries should be installed into $(JED_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(JED_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(JED_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(JED_IPK_DIR)$(OPTWARE_PREFIX)etc/jed/...
# Documentation files should be installed in $(JED_IPK_DIR)$(OPTWARE_PREFIX)doc/jed/...
# Daemon startup scripts should be installed in $(JED_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??jed
#
...
#	install -m 755 $(JED_SOURCE_DIR)/rc.jed $(JED_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXjed
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(JED_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXjed
