...
#LIBIDN_CONFFILES=$(OPTWARE_PREFIX)etc/libidn.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibidn
...
#
# Binaries should be installed into $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX)etc/libidn/...
# Documentation files should be installed in $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX)doc/libidn/...
# Daemon startup scripts should be installed in $(LIBIDN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libidn
#
