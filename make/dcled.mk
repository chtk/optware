...
#DCLED_CONFFILES=$(OPTWARE_PREFIX)etc/dcled.conf $(OPTWARE_PREFIX)etc/init.d/SXXdcled
...
#
# Binaries should be installed into $(DCLED_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(DCLED_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(DCLED_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(DCLED_IPK_DIR)$(OPTWARE_PREFIX)etc/dcled/...
# Documentation files should be installed in $(DCLED_IPK_DIR)$(OPTWARE_PREFIX)doc/dcled/...
# Daemon startup scripts should be installed in $(DCLED_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??dcled
#
