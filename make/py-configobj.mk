...
#PY-CONFIGOBJ_CONFFILES=$(OPTWARE_PREFIX)etc/py-configobj.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-configobj
...
#
# Binaries should be installed into $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX)etc/py-configobj/...
# Documentation files should be installed in $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX)doc/py-configobj/...
# Daemon startup scripts should be installed in $(PY-CONFIGOBJ_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-configobj
#
...
#
py-configobj-ipk: $(PY25-CONFIGOBJ_IPK) $(PY26-CONFIGOBJ_IPK)
...
#
py-configobj-check: $(PY25-CONFIGOBJ_IPK) $(PY26-CONFIGOBJ_IPK)
