...
#MSYNCTOOL_CONFFILES=$(OPTWARE_PREFIX)etc/msynctool.conf $(OPTWARE_PREFIX)etc/init.d/SXXmsynctool
...
#
# Binaries should be installed into $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/msynctool/...
# Documentation files should be installed in $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)doc/msynctool/...
# Daemon startup scripts should be installed in $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??msynctool
#
...
#	install -d $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(MSYNCTOOL_SOURCE_DIR)/msynctool.conf $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/msynctool.conf
#	install -d $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(MSYNCTOOL_SOURCE_DIR)/rc.msynctool $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmsynctool
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(MSYNCTOOL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXmsynctool
