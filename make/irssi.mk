...
#IRSSI_CONFFILES=$(OPTWARE_PREFIX)etc/irssi.conf $(OPTWARE_PREFIX)etc/init.d/SXXirssi
...
#
# Binaries should be installed into $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX)etc/irssi/...
# Documentation files should be installed in $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX)doc/irssi/...
# Daemon startup scripts should be installed in $(IRSSI_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??irssi
#
