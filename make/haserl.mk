...
#HASERL_CONFFILES=$(OPTWARE_PREFIX)etc/haserl.conf $(OPTWARE_PREFIX)etc/init.d/SXXhaserl
...
#
# Binaries should be installed into $(HASERL_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HASERL_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HASERL_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HASERL_IPK_DIR)$(OPTWARE_PREFIX)etc/haserl/...
# Documentation files should be installed in $(HASERL_IPK_DIR)$(OPTWARE_PREFIX)doc/haserl/...
# Daemon startup scripts should be installed in $(HASERL_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??haserl
#
