...
#PY-WEBPY_CONFFILES=$(OPTWARE_PREFIX)etc/py-webpy.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-webpy
...
#
# Binaries should be installed into $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)etc/py-webpy/...
# Documentation files should be installed in $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)doc/py-webpy/...
# Daemon startup scripts should be installed in $(PY-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-webpy
#
...
#	$(STRIP_COMMAND) `find $(PY26-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages -name '*.so'`
...
#	$(STRIP_COMMAND) `find $(PY25-WEBPY_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages -name '*.so'`
