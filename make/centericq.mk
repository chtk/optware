...
CENTERICQ_CONFFILES=
#$(OPTWARE_PREFIX)etc/centericq.conf $(OPTWARE_PREFIX)etc/init.d/SXXcentericq
...
#
# Binaries should be installed into $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/centericq/...
# Documentation files should be installed in $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)doc/centericq/...
# Daemon startup scripts should be installed in $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??centericq
#
...
$(CENTERICQ_IPK): $(CENTERICQ_BUILD_DIR)/.built
	...
	$(STRIP_COMMAND) $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)bin/centericq
#	install -d $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(CENTERICQ_SOURCE_DIR)/centericq.conf $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/centericq.conf
#	install -d $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(CENTERICQ_SOURCE_DIR)/rc.centericq $(CENTERICQ_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXcentericq
