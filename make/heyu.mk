...
#
# Binaries should be installed into $(HEYU_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HEYU_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HEYU_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HEYU_IPK_DIR)$(OPTWARE_PREFIX)etc/heyu/...
# Documentation files should be installed in $(HEYU_IPK_DIR)$(OPTWARE_PREFIX)doc/heyu/...
# Daemon startup scripts should be installed in $(HEYU_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??heyu
#
