...
#EZ-IPUPDATE_CONFFILES=$(OPTWARE_PREFIX)etc/ez-ipupdate.conf $(OPTWARE_PREFIX)etc/init.d/SXXez-ipupdate
...
#
# Binaries should be installed into $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX)etc/ez-ipupdate/...
# Documentation files should be installed in $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX)doc/ez-ipupdate/...
# Daemon startup scripts should be installed in $(EZ-IPUPDATE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ez-ipupdate
#
