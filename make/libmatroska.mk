...
#LIBMATROSKA_CONFFILES=$(OPTWARE_PREFIX)etc/libmatroska.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibmatroska
...
#
# Binaries should be installed into $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)etc/libmatroska/...
# Documentation files should be installed in $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)doc/libmatroska/...
# Daemon startup scripts should be installed in $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libmatroska
#
...
$(LIBMATROSKA_IPK): $(LIBMATROSKA_BUILD_DIR)/.built
	...
	$(MAKE) -C $(LIBMATROSKA_BUILD_DIR)/make/linux install_sharedlib \
		...
		prefix=$(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)\
		;
	$(STRIP_COMMAND) $(LIBMATROSKA_IPK_DIR)$(OPTWARE_PREFIX)lib/libmatroska.so.*
