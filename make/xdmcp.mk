...
#
# Binaries should be installed into $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)etc/xdmcp/...
# Documentation files should be installed in $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)doc/xdmcp/...
# Daemon startup scripts should be installed in $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xdmcp
#
...
$(XDMCP_IPK): $(XDMCP_BUILD_DIR)/.built
	...
	rm -f $(XDMCP_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
