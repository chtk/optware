...
#PY-BOTO_CONFFILES=$(OPTWARE_PREFIX)etc/py-boto.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-boto
...
#
# Binaries should be installed into $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX)etc/py-boto/...
# Documentation files should be installed in $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX)doc/py-boto/...
# Daemon startup scripts should be installed in $(PY-BOTO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-boto
#
...
#	$(STRIP_COMMAND) $(PY25-BOTO_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/boto/*.so
...
#	$(STRIP_COMMAND) $(PY26-BOTO_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/boto/*.so
	for f in $(PY26-BOTO_IPK_DIR)$(OPTWARE_PREFIX)*bin/*; \
