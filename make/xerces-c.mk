...
#XERCES-C_CONFFILES=$(OPTWARE_PREFIX)etc/xerces-c.conf $(OPTWARE_PREFIX)etc/init.d/SXXxerces-c
...
$(XERCES-C_BUILD_DIR)/.configured: $(DL_DIR)/$(XERCES-C_SOURCE) $(XERCES-C_PATCHES) make/xerces-c.mk
	...
	(cd $(@D); \
		...
		--disable-static \
		--disable-pretty-make \
		--with-curl=$(STAGING_DIR)$(OPTWARE_PREFIX)\
		--with-icu=$(STAGING_DIR)$(OPTWARE_PREFIX)\
	)
...
#
# Binaries should be installed into $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/xerces-c/...
# Documentation files should be installed in $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)doc/xerces-c/...
# Daemon startup scripts should be installed in $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xerces-c
#
...
#	install -d $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(XERCES-C_SOURCE_DIR)/xerces-c.conf $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/xerces-c.conf
#	install -d $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(XERCES-C_SOURCE_DIR)/rc.xerces-c $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXxerces-c
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XERCES-C_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXxerces-c
