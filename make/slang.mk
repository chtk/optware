...
#SLANG_CONFFILES=$(OPTWARE_PREFIX)etc/slang.conf $(OPTWARE_PREFIX)etc/init.d/SXXslang
...
SLANG_CPPFLAGS+=-fno-builtin-exp -fno-builtin-ceil \
-fno-builtin-log -fno-builtin-log10 \
-fno-builtin-cos -fno-builtin-cosh -fno-builtin-acos \
-fno-builtin-sin -fno-builtin-sinh -fno-builtin-asin \
-fno-builtin-tan -fno-builtin-tanh -fno-builtin-atan
endif
SLANG_LDFLAGS=
...
#
# Binaries should be installed into $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SLANG_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/slang/...
# Documentation files should be installed in $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)doc/slang/...
# Daemon startup scripts should be installed in $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??slang
#
...
$(SLANG_IPK): $(SLANG_BUILD_DIR)/.built
	...
	rm -f $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)lib/libslang.a
	$(STRIP_COMMAND) $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)bin/slsh \
		$(SLANG_IPK_DIR)$(OPTWARE_PREFIX)lib/libslang.so.$(SLANG_VERSION) \
		$(SLANG_IPK_DIR)$(OPTWARE_PREFIX)lib/slang/v2/modules/*.so
#	install -d $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(SLANG_SOURCE_DIR)/slang.conf $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/slang.conf
#	install -d $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(SLANG_SOURCE_DIR)/rc.slang $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXslang
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SLANG_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXslang
