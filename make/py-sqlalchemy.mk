...
#PY-SQLALCHEMY_CONFFILES=$(OPTWARE_PREFIX)etc/py-sqlalchemy.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-sqlalchemy
...
#
# Binaries should be installed into $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX)etc/py-sqlalchemy/...
# Documentation files should be installed in $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX)doc/py-sqlalchemy/...
# Daemon startup scripts should be installed in $(PY-SQLALCHEMY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-sqlalchemy
#
...
#
py-sqlalchemy-ipk: $(PY25-SQLALCHEMY_IPK) $(PY26-SQLALCHEMY_IPK)
...
#
py-sqlalchemy-check: $(PY25-SQLALCHEMY_IPK) $(PY26-SQLALCHEMY_IPK)
