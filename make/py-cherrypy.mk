...
#PY-CHERRYPY_CONFFILES=$(OPTWARE_PREFIX)etc/py-cherrypy.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-cherrypy
...
#
# Binaries should be installed into $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX)etc/py-cherrypy/...
# Documentation files should be installed in $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX)doc/py-cherrypy/...
# Daemon startup scripts should be installed in $(PY-CHERRYPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-cherrypy
#
