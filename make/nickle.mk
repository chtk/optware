...
#NICKLE_CONFFILES=$(OPTWARE_PREFIX)etc/nickle.conf $(OPTWARE_PREFIX)etc/init.d/SXXnickle
...
#
# Binaries should be installed into $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX)etc/nickle/...
# Documentation files should be installed in $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX)doc/nickle/...
# Daemon startup scripts should be installed in $(NICKLE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??nickle
#
