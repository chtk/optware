...
#
# Binaries should be installed into $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)etc/bftpd/...
# Documentation files should be installed in $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)doc/bftpd/...
# Daemon startup scripts should be installed in $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??bftpd
#
...
#	install -m 755 $(BFTPD_SOURCE_DIR)/rc.bftpd $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXbftpd
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(BFTPD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXbftpd
