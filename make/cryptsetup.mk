...
#CRYPTSETUP_CONFFILES=$(OPTWARE_PREFIX)etc/cryptsetup.conf $(OPTWARE_PREFIX)etc/init.d/SXXcryptsetup
...
#
# Binaries should be installed into $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX)etc/cryptsetup/...
# Documentation files should be installed in $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX)doc/cryptsetup/...
# Daemon startup scripts should be installed in $(CRYPTSETUP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cryptsetup
#
