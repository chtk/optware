...
#VT4-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/vt4-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXvt4-kernel-modules
...
#
# Binaries should be installed into $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/vt4-kernel-modules/...
# Documentation files should be installed in $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/vt4-kernel-modules/...
# Daemon startup scripts should be installed in $(VT4-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??vt4-kernel-modules
#
