...
#
# Binaries should be installed into $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)etc/freetds/...
# Documentation files should be installed in $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)doc/freetds/...
# Daemon startup scripts should be installed in $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??freetds
#
...
#	install -m 755 $(FREETDS_SOURCE_DIR)/rc.freetds $(FREETDS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXfreetds
