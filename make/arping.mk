...
#ARPING_CONFFILES=$(OPTWARE_PREFIX)etc/arping.conf $(OPTWARE_PREFIX)etc/init.d/SXXarping
...
#
# Binaries should be installed into $(ARPING_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ARPING_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ARPING_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ARPING_IPK_DIR)$(OPTWARE_PREFIX)etc/arping/...
# Documentation files should be installed in $(ARPING_IPK_DIR)$(OPTWARE_PREFIX)doc/arping/...
# Daemon startup scripts should be installed in $(ARPING_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??arping
#
