...
#NBD_CONFFILES=$(OPTWARE_PREFIX)etc/nbd.conf $(OPTWARE_PREFIX)etc/init.d/SXXnbd
...
#
# Binaries should be installed into $(NBD_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(NBD_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(NBD_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(NBD_IPK_DIR)$(OPTWARE_PREFIX)etc/nbd/...
# Documentation files should be installed in $(NBD_IPK_DIR)$(OPTWARE_PREFIX)doc/nbd/...
# Daemon startup scripts should be installed in $(NBD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??nbd
#
