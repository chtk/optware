...
#
# Binaries should be installed into $(FLAC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FLAC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FLAC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FLAC_IPK_DIR)$(OPTWARE_PREFIX)etc/flac/...
# Documentation files should be installed in $(FLAC_IPK_DIR)$(OPTWARE_PREFIX)doc/flac/...
# Daemon startup scripts should be installed in $(FLAC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??flac
#
