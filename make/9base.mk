...
$(9BASE_HOST_BUILD_DIR)/.built: host/.configured $(DL_DIR)/$(9BASE_SOURCE) make/9base.mk
	...
	sed -i -e 's|/usr/local/plan9|/$(OPTWARE_PREFIX)/lib/9base|' \
...
#
# Binaries should be installed into $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX)sbin or $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX)etc/9base/...
# Documentation files should be installed in $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX)doc/9base/...
# Daemon startup scripts should be installed in $(9BASE_IPK_DIR)/$(OPTWARE_PREFIX)etc/init.d/S??9base
#
