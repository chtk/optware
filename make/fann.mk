...
#FANN_CONFFILES=$(OPTWARE_PREFIX)etc/fann.conf $(OPTWARE_PREFIX)etc/init.d/SXXfann
...
#
# Binaries should be installed into $(FANN_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FANN_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FANN_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FANN_IPK_DIR)$(OPTWARE_PREFIX)etc/fann/...
# Documentation files should be installed in $(FANN_IPK_DIR)$(OPTWARE_PREFIX)doc/fann/...
# Daemon startup scripts should be installed in $(FANN_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??fann
#
