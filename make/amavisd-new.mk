...
#
# Binaries should be installed into $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX)etc/amavisd-new/...
# Documentation files should be installed in $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX)doc/amavisd-new/...
# Daemon startup scripts should be installed in $(AMAVISD-NEW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??amavisd-new
#
