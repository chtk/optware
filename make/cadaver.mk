...
#CADAVER_CONFFILES=$(OPTWARE_PREFIX)etc/cadaver.conf $(OPTWARE_PREFIX)etc/init.d/SXXcadaver
...
#
# Binaries should be installed into $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX)etc/cadaver/...
# Documentation files should be installed in $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX)doc/cadaver/...
# Daemon startup scripts should be installed in $(CADAVER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cadaver
#
