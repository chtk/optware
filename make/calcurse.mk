...
#CALCURSE_CONFFILES=$(OPTWARE_PREFIX)etc/calcurse.conf $(OPTWARE_PREFIX)etc/init.d/SXXcalcurse
...
#
# Binaries should be installed into $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX)etc/calcurse/...
# Documentation files should be installed in $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX)doc/calcurse/...
# Daemon startup scripts should be installed in $(CALCURSE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??calcurse
#
