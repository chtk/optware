...
#
# Binaries should be installed into $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)etc/puppy/...
# Documentation files should be installed in $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)doc/puppy/...
# Daemon startup scripts should be installed in $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??puppy
#
# You may need to patch your application to make it use these locations.
#
$(PUPPY_IPK): $(PUPPY_BUILD_DIR)/.built
	rm -rf $(PUPPY_IPK_DIR) $(BUILD_DIR)/puppy_*_$(TARGET_ARCH).ipk
	install -d $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(PUPPY_BUILD_DIR)/puppy -o $(PUPPY_IPK_DIR)$(OPTWARE_PREFIX)bin/puppy
