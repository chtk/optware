...
#IOTOP_CONFFILES=$(OPTWARE_PREFIX)etc/iotop.conf $(OPTWARE_PREFIX)etc/init.d/SXXiotop
...
#
# Binaries should be installed into $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/iotop/...
# Documentation files should be installed in $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX)doc/iotop/...
# Daemon startup scripts should be installed in $(IOTOP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??iotop
#
