...
#OBEXFTP_CONFFILES=$(OPTWARE_PREFIX)etc/obexftp.conf $(OPTWARE_PREFIX)etc/init.d/SXXobexftp
...
#
# Binaries should be installed into $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/obexftp/...
# Documentation files should be installed in $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)doc/obexftp/...
# Daemon startup scripts should be installed in $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??obexftp
#
...
$(OBEXFTP_IPK): $(OBEXFTP_BUILD_DIR)/.built
	...
	rm -f $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
	$(STRIP_COMMAND) $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)lib/lib*.so.[0-9]*.[0-9]*.[0-9]*
#	install -d $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(OBEXFTP_SOURCE_DIR)/obexftp.conf $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/obexftp.conf
#	install -d $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(OBEXFTP_SOURCE_DIR)/rc.obexftp $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXobexftp
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(OBEXFTP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXobexftp
