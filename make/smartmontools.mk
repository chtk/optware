...
SMARTMONTOOLS_CONFFILES=$(OPTWARE_PREFIX)etc/smartd.conf $(OPTWARE_PREFIX)etc/init.d/S20smartmontools
...
$(SMARTMONTOOLS_IPK): $(SMARTMONTOOLS_BUILD_DIR)/.built
	...
	install -d $(SMARTMONTOOLS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
	rm -rf $(SMARTMONTOOLS_IPK_DIR)$(OPTWARE_PREFIX)etc/rc.d
	rm -rf $(SMARTMONTOOLS_IPK_DIR)$(OPTWARE_PREFIX)man
	rm -rf $(SMARTMONTOOLS_IPK_DIR)$(OPTWARE_PREFIX)share
	install -m 755 $(SMARTMONTOOLS_SOURCE_DIR)/rc.smartmontools $(SMARTMONTOOLS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S20smartmontools
