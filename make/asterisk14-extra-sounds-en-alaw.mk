...
#ASTERISK14_EXTRA_SOUNDS_EN_ALAW_CONFFILES=$(OPTWARE_PREFIX)etc/asterisk14-extra-sounds-en-alaw.conf $(OPTWARE_PREFIX)etc/init.d/SXXasterisk14-extra-sounds-en-alaw
...
#
# Binaries should be installed into $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)etc/asterisk14-extra-sounds-en-alaw/...
# Documentation files should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)doc/asterisk14-extra-sounds-en-alaw/...
# Daemon startup scripts should be installed in $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??asterisk14-extra-sounds-en-alaw
#
...
$(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK): $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_BUILD_DIR)/.built
	...
	install -d $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds
	install -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_BUILD_DIR)/*.alaw $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds
	install -d $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds/ha
	install -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_BUILD_DIR)/ha/*.alaw $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds/ha
	install -d $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds/wx
	install -m 644 $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_BUILD_DIR)/wx/*.alaw $(ASTERISK14_EXTRA_SOUNDS_EN_ALAW_IPK_DIR)$(OPTWARE_PREFIX)var/lib/asterisk/sounds/wx
