...
#
# Binaries should be installed into $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)etc/extract-xiso/...
# Documentation files should be installed in $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)doc/extract-xiso/...
# Daemon startup scripts should be installed in $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??extract-xiso
#
...
$(EXTRACT-XISO_IPK): $(EXTRACT-XISO_BUILD_DIR)/.built
	...
	install -d $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)/bin/
	install -m 755 $(EXTRACT-XISO_BUILD_DIR)/extract-xiso $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)/bin/
	$(STRIP_COMMAND) $(EXTRACT-XISO_BUILD_DIR)/extract-xiso -o $(EXTRACT-XISO_IPK_DIR)$(OPTWARE_PREFIX)/bin/extract-xiso
