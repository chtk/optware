...
#HUGS_CONFFILES=$(OPTWARE_PREFIX)etc/hugs.conf $(OPTWARE_PREFIX)etc/init.d/SXXhugs
...
#
# Binaries should be installed into $(HUGS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(HUGS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(HUGS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(HUGS_IPK_DIR)$(OPTWARE_PREFIX)etc/hugs/...
# Documentation files should be installed in $(HUGS_IPK_DIR)$(OPTWARE_PREFIX)doc/hugs/...
# Daemon startup scripts should be installed in $(HUGS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??hugs
#
