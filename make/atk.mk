...
#ATK_CONFFILES=$(OPTWARE_PREFIX)etc/atk.conf $(OPTWARE_PREFIX)etc/init.d/SXXatk
...
#
# Binaries should be installed into $(ATK_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ATK_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ATK_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ATK_IPK_DIR)$(OPTWARE_PREFIX)etc/atk/...
# Documentation files should be installed in $(ATK_IPK_DIR)$(OPTWARE_PREFIX)doc/atk/...
# Daemon startup scripts should be installed in $(ATK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??atk
#
