...
#PY-SIMPY_CONFFILES=$(OPTWARE_PREFIX)etc/py-simpy.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-simpy
...
#
# Binaries should be installed into $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX)etc/py-simpy/...
# Documentation files should be installed in $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX)doc/py-simpy/...
# Daemon startup scripts should be installed in $(PY-SIMPY_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-simpy
#
...
$(PY-SIMPY-DOC_IPK): $(PY-SIMPY_BUILD_DIR)/.built
	...
	install -d $(PY-SIMPY-DOC_IPK_DIR)$(OPTWARE_PREFIX)share/doc/SimPy/
	install -m 644 $(PY-SIMPY_BUILD_DIR)/2.6/PKG-INFO $(PY-SIMPY-DOC_IPK_DIR)$(OPTWARE_PREFIX)share/doc/SimPy/
	cp -rp $(PY-SIMPY_BUILD_DIR)/2.6/LGPLlicense_files $(PY-SIMPY-DOC_IPK_DIR)$(OPTWARE_PREFIX)share/doc/SimPy/
	cp -rp $(PY-SIMPY_BUILD_DIR)/2.6/SimPyDocs $(PY-SIMPY-DOC_IPK_DIR)$(OPTWARE_PREFIX)share/doc/SimPy/
	cp -rp $(PY-SIMPY_BUILD_DIR)/2.6/SimPyModels $(PY-SIMPY-DOC_IPK_DIR)$(OPTWARE_PREFIX)share/doc/SimPy/
