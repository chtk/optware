...
#PY-TAILOR_CONFFILES=$(OPTWARE_PREFIX)etc/py-tailor.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-tailor
...
#
# Binaries should be installed into $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)etc/py-tailor/...
# Documentation files should be installed in $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)doc/py-tailor/...
# Daemon startup scripts should be installed in $(PY-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-tailor
#
...
#	-$(STRIP_COMMAND) `find $(PY25-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.5/site-packages/tailor -name '*.so'`
...
$(PY26-TAILOR_IPK): $(PY-TAILOR_BUILD_DIR)/.built
	...
	mv $(PY26-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)bin/tailor $(PY26-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)bin/tailor-2.6
#	-$(STRIP_COMMAND) `find $(PY26-TAILOR_IPK_DIR)$(OPTWARE_PREFIX)lib/python2.6/site-packages/tailor -name '*.so'`
