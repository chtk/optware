...
#
# Binaries should be installed into $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)etc/w3cam/...
# Documentation files should be installed in $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)doc/w3cam/...
# Daemon startup scripts should be installed in $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??w3cam
#
...
$(W3CAM_IPK): $(W3CAM_BUILD_DIR)/.built
	...
	install -d $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)bin/
	install -d $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)sbin/
	install -d $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)man/man1
	install -d $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)share/apache2/htdocs/cgi-bin/
	install -m 755 $(W3CAM_BUILD_DIR)/w3camd/w3camd $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)sbin/w3camd
	install -m 755 $(W3CAM_BUILD_DIR)/w3cam.cgi $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)share/apache2/htdocs/cgi-bin/w3cam.cgi
	install -m 755 $(W3CAM_BUILD_DIR)/vidcat $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)bin/vidcat
	install -m 644 $(W3CAM_BUILD_DIR)/vidcat.1 $(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)man/man1/vidcat.1
	$(MAKE) $(W3CAM_IPK_DIR)/CONTROL/control
	$(STRIP_COMMAND) \
		$(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)bin/vidcat \
		$(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)sbin/w3camd \
		$(W3CAM_IPK_DIR)$(OPTWARE_PREFIX)share/apache2/htdocs/cgi-bin/w3cam.cgi
