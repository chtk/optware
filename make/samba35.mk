...
SAMBA35_INST_DIR=$(OPTWARE_PREFIX)
...
ifeq ($(OPTWARE_TARGET), $(filter ds101 ds101g, $(OPTWARE_TARGET)))
	...
	# samba3-dev
	install -d $(SAMBA35-DEV_IPK_DIR)$(OPTWARE_PREFIX)
	...
	sed -i -e "s,/opt/,$(OPTWARE_PREFIX)/,g" \
		$(subst $(OPTWARE_PREFIX),$(SAMBA35_IPK_DIR)$(OPTWARE_PREFIX),$(SAMBA35_CONFFILES)) \
		$(SAMBA35_IPK_DIR)/CONTROL/postinst
	...
	sed -i -e "s,/opt/,$(OPTWARE_PREFIX)/,g" \
		$(subst $(OPTWARE_PREFIX),$(SAMBA35-SWAT_IPK_DIR)$(OPTWARE_PREFIX),$(SAMBA35-SWAT_CONFFILES))
