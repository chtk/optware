...
#RLFE_CONFFILES=$(OPTWARE_PREFIX)etc/rlfe.conf $(OPTWARE_PREFIX)etc/init.d/SXXrlfe
...
#
# Binaries should be installed into $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(RLFE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/rlfe/...
# Documentation files should be installed in $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)doc/rlfe/...
# Daemon startup scripts should be installed in $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??rlfe
#
...
#	$(MAKE) -C $(RLFE_BUILD_DIR)/examples/rlfe DESTDIR=$(RLFE_IPK_DIR) install_bin
	install -d $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)bin/
	install $(RLFE_BUILD_DIR)/examples/rlfe/rlfe $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)bin/
	$(STRIP_COMMAND) $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)bin/*
#	install -d $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(RLFE_SOURCE_DIR)/rlfe.conf $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/rlfe.conf
#	install -d $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(RLFE_SOURCE_DIR)/rc.rlfe $(RLFE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXrlfe
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXrlfe
