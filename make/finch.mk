...
#FINCH_CONFFILES=$(OPTWARE_PREFIX)etc/finch.conf $(OPTWARE_PREFIX)etc/init.d/SXXfinch
...
#
# Binaries should be installed into $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(FINCH_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)etc/finch/...
# Documentation files should be installed in $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)doc/finch/...
# Daemon startup scripts should be installed in $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??finch
#
...
#	install -m 755 $(FINCH_SOURCE_DIR)/rc.finch $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXfinch
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(FINCH_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXfinch
