...
#CKSFV_CONFFILES=$(OPTWARE_PREFIX)etc/cksfv.conf $(OPTWARE_PREFIX)etc/init.d/SXXcksfv
...
#
# Binaries should be installed into $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX)etc/cksfv/...
# Documentation files should be installed in $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX)doc/cksfv/...
# Daemon startup scripts should be installed in $(CKSFV_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??cksfv
#
