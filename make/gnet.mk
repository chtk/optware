...
#GNET_CONFFILES=$(OPTWARE_PREFIX)etc/gnet.conf $(OPTWARE_PREFIX)etc/init.d/SXXgnet
...
#
# Binaries should be installed into $(GNET_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GNET_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GNET_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/gnet/...
# Documentation files should be installed in $(GNET_IPK_DIR)$(OPTWARE_PREFIX)doc/gnet/...
# Daemon startup scripts should be installed in $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gnet
#
...
#	install -d $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(GNET_SOURCE_DIR)/gnet.conf $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/gnet.conf
#	install -d $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(GNET_SOURCE_DIR)/rc.gnet $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgnet
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(GNET_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgnet
