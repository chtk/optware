...
#PY-PEXPECT_CONFFILES=$(OPTWARE_PREFIX)etc/py-pexpect.conf $(OPTWARE_PREFIX)etc/init.d/SXXpy-pexpect
...
#
# Binaries should be installed into $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX)etc/py-pexpect/...
# Documentation files should be installed in $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX)doc/py-pexpect/...
# Daemon startup scripts should be installed in $(PY-PEXPECT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??py-pexpect
#
