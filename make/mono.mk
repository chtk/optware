...
#MONO_CONFFILES=$(OPTWARE_PREFIX)etc/mono.conf $(OPTWARE_PREFIX)etc/init.d/SXXmono
...
#
# Binaries should be installed into $(MONO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(MONO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(MONO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(MONO_IPK_DIR)$(OPTWARE_PREFIX)etc/mono/...
# Documentation files should be installed in $(MONO_IPK_DIR)$(OPTWARE_PREFIX)doc/mono/...
# Daemon startup scripts should be installed in $(MONO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??mono
#
...
ifneq ($(HOSTCC), $(TARGET_CC))
	rm -f $(MONO_IPK_DIR)$(OPTWARE_PREFIX)bin/jay
endif
	cd $(MONO_IPK_DIR)$(OPTWARE_PREFIX)lib/mono && \
