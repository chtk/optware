...
WERC_CONFFILES=$(OPTWARE_PREFIX)share/www/werc/etc/initrc
...
#	$(MAKE) <bar>-stage <baz>-stage
	...
	sed -i -e '1s|#!.*|#!$(OPTWARE_PREFIX)lib/9base/bin/rc|' $(@D)/bin/werc.rc
#	(cd $(@D); \
...
#
# Binaries should be installed into $(WERC_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(WERC_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(WERC_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(WERC_IPK_DIR)$(OPTWARE_PREFIX)etc/werc/...
# Documentation files should be installed in $(WERC_IPK_DIR)$(OPTWARE_PREFIX)doc/werc/...
# Daemon startup scripts should be installed in $(WERC_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??werc
#
...
#	$(MAKE) -C $(WERC_BUILD_DIR) DESTDIR=$(WERC_IPK_DIR) install-strip
	install -d $(WERC_IPK_DIR)$(OPTWARE_PREFIX)share/www
	rsync -av $(WERC_BUILD_DIR) $(WERC_IPK_DIR)$(OPTWARE_PREFIX)share/www/
	rm -f $(WERC_IPK_DIR)$(OPTWARE_PREFIX)share/www/werc/.configured \
	      $(WERC_IPK_DIR)$(OPTWARE_PREFIX)share/www/werc/.built
