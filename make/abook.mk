...
#
# Binaries should be installed into $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX)etc/abook/...
# Documentation files should be installed in $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX)doc/abook/...
# Daemon startup scripts should be installed in $(ABOOK_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??abook
#
