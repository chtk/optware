...
#ICU_CONFFILES=$(OPTWARE_PREFIX)etc/icu.conf $(OPTWARE_PREFIX)etc/init.d/SXXicu
...
#
# Binaries should be installed into $(ICU_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(ICU_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ICU_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ICU_IPK_DIR)$(OPTWARE_PREFIX)etc/icu/...
# Documentation files should be installed in $(ICU_IPK_DIR)$(OPTWARE_PREFIX)doc/icu/...
# Daemon startup scripts should be installed in $(ICU_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??icu
#
...
#	install -m 755 $(ICU_SOURCE_DIR)/rc.icu $(ICU_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXicu
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(ICU_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXicu
