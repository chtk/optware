...
#LEAFNODE_CONFFILES=$(OPTWARE_PREFIX)etc/leafnode.conf $(OPTWARE_PREFIX)etc/init.d/SXXleafnode
...
#
# Binaries should be installed into $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX)etc/leafnode/...
# Documentation files should be installed in $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX)doc/leafnode/...
# Daemon startup scripts should be installed in $(LEAFNODE_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??leafnode
#
