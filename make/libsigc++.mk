...
#
# Binaries should be installed into $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)etc/libsigc++/...
# Documentation files should be installed in $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)doc/libsigc++/...
# Daemon startup scripts should be installed in $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libsigc++
#
...
$(LIBSIGC++_IPK): $(LIBSIGC++_BUILD_DIR)/.built
	...
	rm -rf $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)include
	rm -rf $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)share
	rm -rf $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)lib/pkgconfig
	rm -rf $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
	rm -rf $(LIBSIGC++_IPK_DIR)$(OPTWARE_PREFIX)lib/sigc++-2.0
