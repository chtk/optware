...
#
# Binaries should be installed into $(GZIP_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GZIP_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GZIP_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GZIP_IPK_DIR)$(OPTWARE_PREFIX)etc/gzip/...
# Documentation files should be installed in $(GZIP_IPK_DIR)$(OPTWARE_PREFIX)doc/gzip/...
# Daemon startup scripts should be installed in $(GZIP_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gzip
#
