...
#LIBMPDCLIENT_CONFFILES=$(OPTWARE_PREFIX)etc/libmpdclient.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibmpdclient
...
#
# Binaries should be installed into $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/libmpdclient/...
# Documentation files should be installed in $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)doc/libmpdclient/...
# Daemon startup scripts should be installed in $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libmpdclient
#
...
#	install -d $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(LIBMPDCLIENT_SOURCE_DIR)/libmpdclient.conf $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/libmpdclient.conf
#	install -d $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(LIBMPDCLIENT_SOURCE_DIR)/rc.libmpdclient $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibmpdclient
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(LIBMPDCLIENT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXlibmpdclient
