...
#GNUGO_CONFFILES=$(OPTWARE_PREFIX)etc/gnugo.conf $(OPTWARE_PREFIX)etc/init.d/SXXgnugo
...
#
# Binaries should be installed into $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)etc/gnugo/...
# Documentation files should be installed in $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)doc/gnugo/...
# Daemon startup scripts should be installed in $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gnugo
#
...
#	install -m 755 $(GNUGO_SOURCE_DIR)/rc.gnugo $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgnugo
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(GNUGO_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgnugo
