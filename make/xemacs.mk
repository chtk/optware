...
#XEMACS_CONFFILES=$(OPTWARE_PREFIX)etc/xemacs.conf $(OPTWARE_PREFIX)etc/init.d/SXXxemacs
...
#
# Binaries should be installed into $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)etc/xemacs/...
# Documentation files should be installed in $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)doc/xemacs/...
# Daemon startup scripts should be installed in $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xemacs
#
...
$(XEMACS_IPK): $(XEMACS_BUILD_DIR)/.built
	...
	$(MAKE) -C $(XEMACS_BUILD_DIR) prefix=$(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)install
	rm -f $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)bin/xemacs
	ln -s $(OPTWARE_PREFIX)bin/xemacs-$(XEMACS_VERSION) $(XEMACS_IPK_DIR)$(OPTWARE_PREFIX)bin/xemacs
