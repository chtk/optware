...
#TS109-KERNEL-MODULES_CONFFILES=$(OPTWARE_PREFIX)etc/ts109-kernel-modules.conf $(OPTWARE_PREFIX)etc/init.d/SXXts109-kernel-modules
...
#
# Binaries should be installed into $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/ts109-kernel-modules/...
# Documentation files should be installed in $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)doc/ts109-kernel-modules/...
# Daemon startup scripts should be installed in $(TS109-KERNEL-MODULES_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??ts109-kernel-modules
#
