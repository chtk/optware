...
$(LHA_IPK): $(LHA_BUILD_DIR)/.built
	...
	install -d $(LHA_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -m 755 $(LHA_BUILD_DIR)/src/lha $(LHA_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(LHA_IPK_DIR)$(OPTWARE_PREFIX)bin/lha
