...
#
# Binaries should be installed into $(<FOO>_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBDB_IPK_DIR)$(OPTWARE_PREFIX)bin
...
$(LIBDB_IPK): $(LIBDB_BUILD_DIR)/build_unix/.libs/libdb-$(LIBDB_LIB_VERSION).a
	...
	-$(STRIP_COMMAND) $(LIBDB_IPK_DIR)$(OPTWARE_PREFIX)lib/*.so
	rm -f $(LIBDB_IPK_DIR)$(OPTWARE_PREFIX)lib/*.{la,a}
