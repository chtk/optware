...
#SPEEX_CONFFILES=$(OPTWARE_PREFIX)etc/speex.conf $(OPTWARE_PREFIX)etc/init.d/SXXspeex
...
#
# Binaries should be installed into $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/speex/...
# Documentation files should be installed in $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)doc/speex/...
# Daemon startup scripts should be installed in $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??speex
#
...
#	install -d $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/
#	install -m 644 $(SPEEX_SOURCE_DIR)/speex.conf $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/speex.conf
#	install -d $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d
#	install -m 755 $(SPEEX_SOURCE_DIR)/rc.speex $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXspeex
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(SPEEX_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXspeex
