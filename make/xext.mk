...
#
# Binaries should be installed into $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(XEXT_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)etc/xext/...
# Documentation files should be installed in $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)doc/xext/...
# Daemon startup scripts should be installed in $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??xext
#
...
$(XEXT_IPK): $(XEXT_BUILD_DIR)/.built
	...
	rm -f $(XEXT_IPK_DIR)$(OPTWARE_PREFIX)lib/*.la
