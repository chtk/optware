...
#
# Binaries should be installed into $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX)sbin or $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX)etc/adns/...
# Documentation files should be installed in $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX)doc/adns/...
# Daemon startup scripts should be installed in $(ADNS_IPK_DIR)/$(OPTWARE_PREFIX)etc/init.d/S??adns
#
