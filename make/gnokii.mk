...
# GNOKII_CONFFILES=$(OPTWARE_PREFIX)etc/gnokii.conf $(OPTWARE_PREFIX)etc/init.d/SXXgnokii
# GNOKII_SMSD_CONFFILES=$(OPTWARE_PREFIX)etc/gnokii.conf $(OPTWARE_PREFIX)etc/init.d/SXXgnokii
...
#
# Binaries should be installed into $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX)etc/gnokii/...
# Documentation files should be installed in $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX)doc/gnokii/...
# Daemon startup scripts should be installed in $(GNOKII_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??gnokii
#
...
#	sed -i -e '/^#!/aOPTWARE_TARGET=${OPTWARE_TARGET}' $(XINETD_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/SXXgnokii
