...
$(MICROPERL_IPK): $(MICROPERL_BUILD_DIR)/.built
	...
	install -d $(MICROPERL_IPK_DIR)$(OPTWARE_PREFIX)bin
	install -m 755 $(MICROPERL_BUILD_DIR)/microperl $(MICROPERL_IPK_DIR)$(OPTWARE_PREFIX)bin
	$(STRIP_COMMAND) $(MICROPERL_IPK_DIR)$(OPTWARE_PREFIX)bin/*
