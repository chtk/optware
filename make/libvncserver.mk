...
#LIBVNCSERVER_CONFFILES=$(OPTWARE_PREFIX)etc/libvncserver.conf $(OPTWARE_PREFIX)etc/init.d/SXXlibvncserver
...
#
# Binaries should be installed into $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX)etc/libvncserver/...
# Documentation files should be installed in $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX)doc/libvncserver/...
# Daemon startup scripts should be installed in $(LIBVNCSERVER_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??libvncserver
#
