...
#
# Binaries should be installed into $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX)sbin or $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX)bin
# (use the location in a well-known Linux distro as a guide for choosing sbin or bin).
# Libraries and include files should be installed into $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX){lib,include}
# Configuration files should be installed in $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/inetutils/...
# Documentation files should be installed in $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX)doc/inetutils/...
# Daemon startup scripts should be installed in $(INETUTILS_IPK_DIR)$(OPTWARE_PREFIX)etc/init.d/S??inetutils
#
